...
public enum IhmSnapshotFreshness
{
    NeverReceived,
    Fresh,
    Aging,
...
public sealed record IhmObservedValue<T>(
    bool HasValue,
    bool IsAvailable,
    DateTimeOffset? ReceivedAt,
    IhmSnapshotFreshness Freshness,
    T? Value);

public sealed record IhmSystemStateReadModel(
    ushort SystemStatus,
    ushort SystemFlags,
    ushort FaultFlags,
    ushort WarningFlags,
...
public sealed record IhmTimeStateReadModel(
    ushort TimeStatus,
    ushort TimeFlags,
...
public sealed record IhmVibrationStateReadModel(
    ushort StatusGlobal,
...
public sealed record IhmDeviceReadModel(
    ...
    byte ModbusAddress,
    uint? DeviceId,
    IhmSessionState SessionState,
    IhmDeviceTelemetryReadModel? Telemetry);
