...
public sealed class SupervisionReadProjection
{
    ...
    private IhmDeviceTelemetryReadModel ProjectTelemetry(DeviceTelemetrySnapshots snapshots, DateTimeOffset observedAt) =>
        new(
            ...
            ProjectObserved(snapshots.CampaignInventoryState, observedAt, value => new IhmCampaignInventoryReadModel(value.InventoryStructureVersion, value.TotalCampaignCount, value.ValidCampaignCount, value.SelectedCampaignIndex, value.SelectedCampaignValid, value.StorageUsedMb, value.StorageFreeMb, value.StorageHealthStatus, value.CampaignId, value.MissionId, value.StartTimestampSeconds, value.EndTimestampSeconds, value.CampaignState, value.DurationSeconds, value.DataSizeMb, value.CampaignLabel, value.MissionLabel, value.DataIntegrityStatus)),
