# TT-STR-01-B6-001 — Bloc 6 — Structure globale

## Objectif
Valider la cohérence structurelle globale du bloc `6` :
...
- Bloc : `6`
- Adresse début portée : `6000`
- Adresse fin portée : `6063`
- Registres couverts : `64`
- Registres dans la portée : `64`
- Nombre de champs bruts : `20`
- Premier champ : `inventory_structure_version`
- Dernier champ : `reserved_6B`

## Préconditions
- Mapping unifié brut validé
- Couverture par bloc calculée
- Accès Modbus disponible si vérification instrumentée
- Aucun changement de spécification en cours sur le bloc `6`

## Contrôles à effectuer
- vérifier que le premier champ du bloc commence bien à `6000` ;
- vérifier que le dernier champ du bloc se termine bien à `6063` ;
...
## Étapes
1. Lister tous les champs du bloc `6` dans l’ordre croissant des adresses.
2. Vérifier que chaque champ commence à une adresse supérieure ou égale à la fin du précédent + 1.
3. Vérifier que le premier champ commence à `6000`.
4. Vérifier que le dernier champ se termine à `6063`.
5. Vérifier que le nombre total de registres couverts est `64`.
6. Vérifier que le nombre de registres manquants à l’intérieur de la portée est `0`.

## Résultat attendu
- structure du bloc `6` cohérente ;
