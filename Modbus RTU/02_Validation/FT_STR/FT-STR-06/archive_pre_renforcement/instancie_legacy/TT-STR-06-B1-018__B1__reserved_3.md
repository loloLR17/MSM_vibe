# TT-STR-06-B1-018 — Bloc 1 — reserved_3

## Objectif
Valider que le champ logique `reserved_3` est lisible de manière standard, sans dépendance implicite à la taille de requête ni au découpage de lecture.
...
## Résultat attendu
- la lecture exacte de la plage `1019` à `1019` est possible ;
