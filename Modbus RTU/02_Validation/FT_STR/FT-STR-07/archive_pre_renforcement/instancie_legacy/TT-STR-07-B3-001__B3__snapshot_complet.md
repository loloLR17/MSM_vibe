# TT-STR-07-B3-001 — Bloc 3 — Snapshot complet

## Objectif
Valider la stabilité d’image du bloc `3` par comparaison de 20 snapshots complets.
...
## Étapes
1. Lire le bloc complet de `3000` à `3047` 20 fois consécutivement.
