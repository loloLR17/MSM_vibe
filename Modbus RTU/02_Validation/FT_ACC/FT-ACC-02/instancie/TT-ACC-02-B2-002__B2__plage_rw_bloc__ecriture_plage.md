# TT-ACC-02-B2-002 — Bloc 2 — plage_rw_bloc

## Objectif
Vérifier qu’une écriture multi-registres sur la plage de travail `RW` du bloc 2 est techniquement acceptée et correctement relue.

## Exigence(s) couverte(s)
- FT-ACC-02
- Mapping unifié logique TR2
- Couverture des zones `RW` du bloc 2

## Référence mapping
- Bloc : 2
- Adresse début de plage RW : 2008
- Adresse fin de plage RW : 2009
- Taille de la plage : 2 registre(s)
