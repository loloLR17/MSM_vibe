# TT-ACC-02-B5-008 — Bloc 5 — plage_rw_bloc

## Objectif
Vérifier qu’une écriture multi-registres sur la plage de travail `RW` du bloc 5 est techniquement acceptée et correctement relue.

## Exigence(s) couverte(s)
- FT-ACC-02
- Mapping unifié logique TR2
- Couverture des zones `RW` du bloc 5

## Référence mapping
- Bloc : 5
- Adresse début de plage RW : 5000
- Adresse fin de plage RW : 5007
- Taille de la plage : 8 registre(s)
