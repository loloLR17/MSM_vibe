# TT-ACC-04-B4-009 — Bloc 4 — reserved_4E_C

## Objectif
Vérifier que le champ réservé `reserved_4E_C` présente un comportement neutre, stable et sans sémantique cachée.
