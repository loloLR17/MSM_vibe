# TT-ACC-01-B2-002 — Bloc 2 — time_flags

## Objectif
Vérifier que le champ logique `time_flags` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 2001
- Longueur : 1

## Scénario / étapes
1. Lire le registre 2001.
...
- le champ `time_flags` est lisible conformément au mapping.
