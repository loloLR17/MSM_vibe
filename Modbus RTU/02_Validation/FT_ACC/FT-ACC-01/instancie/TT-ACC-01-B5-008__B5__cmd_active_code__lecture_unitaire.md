# TT-ACC-01-B5-008 — Bloc 5 — cmd_active_code

## Objectif
Vérifier que le champ logique `cmd_active_code` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 5008
- Longueur : 1

## Scénario / étapes
1. Lire le registre 5008.
...
- le champ `cmd_active_code` est lisible conformément au mapping.
