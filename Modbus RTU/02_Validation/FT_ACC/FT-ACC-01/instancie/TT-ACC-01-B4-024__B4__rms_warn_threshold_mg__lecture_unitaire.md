# TT-ACC-01-B4-024 — Bloc 4 — rms_warn_threshold_mg

## Objectif
Vérifier que le champ logique `rms_warn_threshold_mg` déclaré lisible est accessible en lecture unitaire.
...
- le champ `rms_warn_threshold_mg` est lisible conformément au mapping.
