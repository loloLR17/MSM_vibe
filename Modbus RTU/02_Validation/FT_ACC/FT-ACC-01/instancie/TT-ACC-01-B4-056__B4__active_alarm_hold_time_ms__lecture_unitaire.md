# TT-ACC-01-B4-056 — Bloc 4 — active_alarm_hold_time_ms

## Objectif
Vérifier que le champ logique `active_alarm_hold_time_ms` déclaré lisible est accessible en lecture unitaire.
...
- le champ `active_alarm_hold_time_ms` est lisible conformément au mapping.
