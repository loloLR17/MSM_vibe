# TT-ACC-01-B0-006 — Bloc 0 — protocol_version

## Objectif
Vérifier que le champ logique `protocol_version` déclaré lisible est accessible en lecture unitaire.
...
- le champ `protocol_version` est lisible conformément au mapping.
