# TT-ACC-01-B6-019 — Bloc 6 — data_integrity_status

## Objectif
Vérifier que le champ logique `data_integrity_status` déclaré lisible est accessible en lecture unitaire.
...
- le champ `data_integrity_status` est lisible conformément au mapping.
