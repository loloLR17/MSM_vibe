# TT-ACC-01-B7-011 — Bloc 7 — internal_temp_dC

## Objectif
Vérifier que le champ logique `internal_temp_dC` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 7012
- Longueur : 1

## Scénario / étapes
1. Lire le registre 7012.
...
- le champ `internal_temp_dC` est lisible conformément au mapping.
