# TT-ACC-01-B3-002 — Bloc 3 — B3_VALIDITY_FLAGS

## Objectif
Vérifier que le champ logique `B3_VALIDITY_FLAGS` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 3001
- Longueur : 1

## Scénario / étapes
1. Lire le registre 3001.
...
- le champ `B3_VALIDITY_FLAGS` est lisible conformément au mapping.
