# TT-ACC-01-B1-006 — Bloc 1 — last_reset_cause

## Objectif
Vérifier que le champ logique `last_reset_cause` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 1006
- Longueur : 1

## Scénario / étapes
1. Lire le registre 1006.
...
- le champ `last_reset_cause` est lisible conformément au mapping.
