# TT-ACC-01-B4-052 — Bloc 4 — active_rms_alarm_threshold_mg

## Objectif
Vérifier que le champ logique `active_rms_alarm_threshold_mg` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 4118
- Longueur : 1

## Scénario / étapes
1. Lire le registre 4118.
...
- le champ `active_rms_alarm_threshold_mg` est lisible conformément au mapping.
