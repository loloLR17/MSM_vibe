# TT-ACC-01-B3-025 — Bloc 3 — B3_ALARM_COUNT

## Objectif
Vérifier que le champ logique multi-registres `B3_ALARM_COUNT` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 3038
- Longueur : 2

## Scénario / étapes
1. Lire les registres 3038 à 3039.
...
- le champ `B3_ALARM_COUNT` est lisible conformément au mapping.
