# TT-ACC-01-B6-003 — Bloc 6 — valid_campaign_count

## Objectif
Vérifier que le champ logique `valid_campaign_count` déclaré lisible est accessible en lecture unitaire.
...
- le champ `valid_campaign_count` est lisible conformément au mapping.
