# TT-ACC-01-B2-011 — Bloc 2 — reserved_1

## Objectif
Vérifier que le champ logique `reserved_1` déclaré lisible est accessible en lecture unitaire.
...
- le champ `reserved_1` est lisible conformément au mapping.
