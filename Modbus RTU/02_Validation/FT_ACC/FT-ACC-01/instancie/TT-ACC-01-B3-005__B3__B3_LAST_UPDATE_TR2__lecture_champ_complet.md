# TT-ACC-01-B3-005 — Bloc 3 — B3_LAST_UPDATE_TR2

## Objectif
Vérifier que le champ logique multi-registres `B3_LAST_UPDATE_TR2` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 3004
- Longueur : 2

## Scénario / étapes
1. Lire les registres 3004 à 3005.
...
- le champ `B3_LAST_UPDATE_TR2` est lisible conformément au mapping.
