# TT-ACC-01-B1-002 — Bloc 1 — system_flags

## Objectif
Vérifier que le champ logique `system_flags` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 1001
- Longueur : 1

## Scénario / étapes
1. Lire le registre 1001.
...
- le champ `system_flags` est lisible conformément au mapping.
