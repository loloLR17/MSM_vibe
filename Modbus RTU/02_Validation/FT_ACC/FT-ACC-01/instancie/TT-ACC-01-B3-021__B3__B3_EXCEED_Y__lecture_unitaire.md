# TT-ACC-01-B3-021 — Bloc 3 — B3_EXCEED_Y

## Objectif
Vérifier que le champ logique `B3_EXCEED_Y` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 3033
- Longueur : 1

## Scénario / étapes
1. Lire le registre 3033.
...
- le champ `B3_EXCEED_Y` est lisible conformément au mapping.
