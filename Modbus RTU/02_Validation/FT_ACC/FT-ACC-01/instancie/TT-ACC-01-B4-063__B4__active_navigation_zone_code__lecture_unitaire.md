# TT-ACC-01-B4-063 — Bloc 4 — active_navigation_zone_code

## Objectif
Vérifier que le champ logique `active_navigation_zone_code` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 4165
- Longueur : 1

## Scénario / étapes
1. Lire le registre 4165.
...
- le champ `active_navigation_zone_code` est lisible conformément au mapping.
