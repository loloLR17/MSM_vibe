# TT-ACC-01-B2-007 — Bloc 2 — prepared_time_status

## Objectif
Vérifier que le champ logique `prepared_time_status` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 2010
- Longueur : 1

## Scénario / étapes
1. Lire le registre 2010.
...
- le champ `prepared_time_status` est lisible conformément au mapping.
