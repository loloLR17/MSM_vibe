# TT-ACC-01-B7-003 — Bloc 7 — system_fault_flags

## Objectif
Vérifier que le champ logique `system_fault_flags` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 7002
- Longueur : 1

## Scénario / étapes
1. Lire le registre 7002.
...
- le champ `system_fault_flags` est lisible conformément au mapping.
