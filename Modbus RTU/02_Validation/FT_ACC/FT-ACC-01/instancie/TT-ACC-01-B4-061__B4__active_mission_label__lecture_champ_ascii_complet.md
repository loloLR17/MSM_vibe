# TT-ACC-01-B4-061 — Bloc 4 — active_mission_label

## Objectif
Vérifier que le champ ASCII fixe `active_mission_label` est accessible en lecture complète sur 16 registres.
...
## Données d’entrée
- Adresse de départ : 4148
- Longueur : 16

## Scénario / étapes
1. Lire les registres 4148 à 4163.
...
- le champ `active_mission_label` est lisible conformément au mapping.
