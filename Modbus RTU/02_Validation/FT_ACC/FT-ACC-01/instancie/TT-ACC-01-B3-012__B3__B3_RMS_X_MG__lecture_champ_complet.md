# TT-ACC-01-B3-012 — Bloc 3 — B3_RMS_X_MG

## Objectif
Vérifier que le champ logique multi-registres `B3_RMS_X_MG` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 3018
- Longueur : 2

## Scénario / étapes
1. Lire les registres 3018 à 3019.
...
- le champ `B3_RMS_X_MG` est lisible conformément au mapping.
