# TT-ACC-01-B4-041 — Bloc 4 — active_axes_enable_mask

## Objectif
Vérifier que le champ logique `active_axes_enable_mask` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 4101
- Longueur : 1

## Scénario / étapes
1. Lire le registre 4101.
...
- le champ `active_axes_enable_mask` est lisible conformément au mapping.
