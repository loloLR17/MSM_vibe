# TT-ACC-01-B4-015 — Bloc 4 — full_scale_code

## Objectif
Vérifier que le champ logique `full_scale_code` déclaré lisible est accessible en lecture unitaire.
...
- le champ `full_scale_code` est lisible conformément au mapping.
