# TT-ACC-01-B4-045 — Bloc 4 — active_indicator_period_ms

## Objectif
Vérifier que le champ logique `active_indicator_period_ms` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 4105
- Longueur : 1

## Scénario / étapes
1. Lire le registre 4105.
...
- le champ `active_indicator_period_ms` est lisible conformément au mapping.
