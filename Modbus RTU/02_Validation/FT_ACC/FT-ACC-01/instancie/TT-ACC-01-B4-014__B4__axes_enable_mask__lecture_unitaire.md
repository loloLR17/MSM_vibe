# TT-ACC-01-B4-014 — Bloc 4 — axes_enable_mask

## Objectif
Vérifier que le champ logique `axes_enable_mask` déclaré lisible est accessible en lecture unitaire.
...
- le champ `axes_enable_mask` est lisible conformément au mapping.
