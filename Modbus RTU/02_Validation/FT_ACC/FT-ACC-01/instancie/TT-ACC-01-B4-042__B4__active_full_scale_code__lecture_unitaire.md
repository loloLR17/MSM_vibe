# TT-ACC-01-B4-042 — Bloc 4 — active_full_scale_code

## Objectif
Vérifier que le champ logique `active_full_scale_code` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 4102
- Longueur : 1

## Scénario / étapes
1. Lire le registre 4102.
...
- le champ `active_full_scale_code` est lisible conformément au mapping.
