# TT-ACC-01-B4-004 — Bloc 4 — active_config_id

## Objectif
Vérifier que le champ logique multi-registres `active_config_id` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 4004
- Longueur : 2

## Scénario / étapes
1. Lire les registres 4004 à 4005.
...
- le champ `active_config_id` est lisible conformément au mapping.
