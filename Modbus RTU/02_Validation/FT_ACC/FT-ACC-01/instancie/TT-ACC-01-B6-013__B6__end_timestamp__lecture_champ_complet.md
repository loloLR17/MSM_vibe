# TT-ACC-01-B6-013 — Bloc 6 — end_timestamp

## Objectif
Vérifier que le champ logique multi-registres `end_timestamp` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 6018
- Longueur : 2

## Scénario / étapes
1. Lire les registres 6018 à 6019.
...
- le champ `end_timestamp` est lisible conformément au mapping.
