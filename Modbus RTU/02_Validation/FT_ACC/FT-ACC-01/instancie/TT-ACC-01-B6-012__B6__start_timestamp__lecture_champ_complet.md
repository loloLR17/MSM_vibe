# TT-ACC-01-B6-012 — Bloc 6 — start_timestamp

## Objectif
Vérifier que le champ logique multi-registres `start_timestamp` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 6016
- Longueur : 2

## Scénario / étapes
1. Lire les registres 6016 à 6017.
...
- le champ `start_timestamp` est lisible conformément au mapping.
