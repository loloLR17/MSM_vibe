# TT-ACC-01-B3-016 — Bloc 3 — B3_PEAK_Y_MG

## Objectif
Vérifier que le champ logique multi-registres `B3_PEAK_Y_MG` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 3026
- Longueur : 2

## Scénario / étapes
1. Lire les registres 3026 à 3027.
...
- le champ `B3_PEAK_Y_MG` est lisible conformément au mapping.
