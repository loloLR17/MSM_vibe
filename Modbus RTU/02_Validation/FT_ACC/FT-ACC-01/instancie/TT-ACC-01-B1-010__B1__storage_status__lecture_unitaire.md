# TT-ACC-01-B1-010 — Bloc 1 — storage_status

## Objectif
Vérifier que le champ logique `storage_status` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 1010
- Longueur : 1

## Scénario / étapes
1. Lire le registre 1010.
...
- le champ `storage_status` est lisible conformément au mapping.
