# TT-ACC-01-B4-012 — Bloc 4 — reserved

## Objectif
Vérifier que le champ logique `reserved` déclaré lisible est accessible en lecture unitaire.
...
- le champ `reserved` est lisible conformément au mapping.
