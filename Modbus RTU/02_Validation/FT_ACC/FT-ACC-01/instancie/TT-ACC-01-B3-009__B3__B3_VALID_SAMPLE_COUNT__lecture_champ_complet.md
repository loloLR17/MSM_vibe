# TT-ACC-01-B3-009 — Bloc 3 — B3_VALID_SAMPLE_COUNT

## Objectif
Vérifier que le champ logique multi-registres `B3_VALID_SAMPLE_COUNT` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 3012
- Longueur : 2

## Scénario / étapes
1. Lire les registres 3012 à 3013.
...
- le champ `B3_VALID_SAMPLE_COUNT` est lisible conformément au mapping.
