# TT-ACC-01-B4-050 — Bloc 4 — active_supervision_enable_mask

## Objectif
Vérifier que le champ logique `active_supervision_enable_mask` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 4116
- Longueur : 1

## Scénario / étapes
1. Lire le registre 4116.
...
- le champ `active_supervision_enable_mask` est lisible conformément au mapping.
