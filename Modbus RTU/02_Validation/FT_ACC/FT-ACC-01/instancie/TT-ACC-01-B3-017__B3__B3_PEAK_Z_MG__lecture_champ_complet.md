# TT-ACC-01-B3-017 — Bloc 3 — B3_PEAK_Z_MG

## Objectif
Vérifier que le champ logique multi-registres `B3_PEAK_Z_MG` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 3028
- Longueur : 2

## Scénario / étapes
1. Lire les registres 3028 à 3029.
...
- le champ `B3_PEAK_Z_MG` est lisible conformément au mapping.
