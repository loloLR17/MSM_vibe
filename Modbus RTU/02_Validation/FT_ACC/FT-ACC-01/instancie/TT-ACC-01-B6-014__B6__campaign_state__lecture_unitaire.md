# TT-ACC-01-B6-014 — Bloc 6 — campaign_state

## Objectif
Vérifier que le champ logique `campaign_state` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 6020
- Longueur : 1

## Scénario / étapes
1. Lire le registre 6020.
...
- le champ `campaign_state` est lisible conformément au mapping.
