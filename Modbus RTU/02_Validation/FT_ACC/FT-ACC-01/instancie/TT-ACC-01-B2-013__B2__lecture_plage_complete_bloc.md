# TT-ACC-01-B2-013 — Bloc 2 — lecture_plage_complete_bloc

## Objectif
Vérifier que la plage complète couverte du bloc 2 est accessible en lecture multi-registres sans erreur.
...
- Adresse début : 2000
- Adresse fin : 2015
- Couverture continue : 16 registres
...
## Données d’entrée
- Adresse de départ : 2000
- Longueur : 16

## Scénario / étapes
1. Lire la plage complète du bloc 2, du registre 2000 au registre 2015.
2. Contrôler l’absence d’exception Modbus.
3. Vérifier que la réponse contient exactement 16 registres.
...
- la plage complète documentée du bloc 2 est lisible.
