# TT-ACC-01-B1-012 — Bloc 1 — acquisition_state

## Objectif
Vérifier que le champ logique `acquisition_state` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 1012
- Longueur : 1

## Scénario / étapes
1. Lire le registre 1012.
...
- le champ `acquisition_state` est lisible conformément au mapping.
