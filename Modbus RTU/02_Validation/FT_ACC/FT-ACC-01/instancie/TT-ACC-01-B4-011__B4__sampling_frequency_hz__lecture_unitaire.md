# TT-ACC-01-B4-011 — Bloc 4 — sampling_frequency_hz

## Objectif
Vérifier que le champ logique `sampling_frequency_hz` déclaré lisible est accessible en lecture unitaire.
...
- le champ `sampling_frequency_hz` est lisible conformément au mapping.
