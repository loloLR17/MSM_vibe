# TT-ACC-01-B2-010 — Bloc 2 — sync_source

## Objectif
Vérifier que le champ logique `sync_source` déclaré lisible est accessible en lecture unitaire.
...
- le champ `sync_source` est lisible conformément au mapping.
