# TT-ACC-01-B3-004 — Bloc 3 — B3_SEVERITY_GLOBAL

## Objectif
Vérifier que le champ logique `B3_SEVERITY_GLOBAL` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 3003
- Longueur : 1

## Scénario / étapes
1. Lire le registre 3003.
...
- le champ `B3_SEVERITY_GLOBAL` est lisible conformément au mapping.
