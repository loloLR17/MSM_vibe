# TT-ACC-01-B3-010 — Bloc 3 — B3_RMS_GLOBAL_MG

## Objectif
Vérifier que le champ logique multi-registres `B3_RMS_GLOBAL_MG` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 3014
- Longueur : 2

## Scénario / étapes
1. Lire les registres 3014 à 3015.
...
- le champ `B3_RMS_GLOBAL_MG` est lisible conformément au mapping.
