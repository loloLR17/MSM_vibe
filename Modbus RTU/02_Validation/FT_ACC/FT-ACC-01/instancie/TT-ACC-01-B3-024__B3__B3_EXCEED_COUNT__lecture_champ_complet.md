# TT-ACC-01-B3-024 — Bloc 3 — B3_EXCEED_COUNT

## Objectif
Vérifier que le champ logique multi-registres `B3_EXCEED_COUNT` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 3036
- Longueur : 2

## Scénario / étapes
1. Lire les registres 3036 à 3037.
...
- le champ `B3_EXCEED_COUNT` est lisible conformément au mapping.
