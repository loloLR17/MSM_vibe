# TT-ACC-01-B2-003 — Bloc 2 — current_time

## Objectif
Vérifier que le champ logique multi-registres `current_time` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 2002
- Longueur : 2

## Scénario / étapes
1. Lire les registres 2002 à 2003.
...
- le champ `current_time` est lisible conformément au mapping.
