# TT-ACC-01-B7-006 — Bloc 7 — selftest_status

## Objectif
Vérifier que le champ logique `selftest_status` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 7006
- Longueur : 1

## Scénario / étapes
1. Lire le registre 7006.
...
- le champ `selftest_status` est lisible conformément au mapping.
