# TT-ACC-01-B3-019 — Bloc 3 — B3_EXCEED_GLOBAL

## Objectif
Vérifier que le champ logique `B3_EXCEED_GLOBAL` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 3031
- Longueur : 1

## Scénario / étapes
1. Lire le registre 3031.
...
- le champ `B3_EXCEED_GLOBAL` est lisible conformément au mapping.
