# TT-ACC-01-B4-020 — Bloc 4 — storage_mode

## Objectif
Vérifier que le champ logique `storage_mode` déclaré lisible est accessible en lecture unitaire.
...
- le champ `storage_mode` est lisible conformément au mapping.
