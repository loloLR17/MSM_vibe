# TT-ACC-01-B2-001 — Bloc 2 — time_status

## Objectif
Vérifier que le champ logique `time_status` déclaré lisible est accessible en lecture unitaire.
...
- le champ `time_status` est lisible conformément au mapping.
