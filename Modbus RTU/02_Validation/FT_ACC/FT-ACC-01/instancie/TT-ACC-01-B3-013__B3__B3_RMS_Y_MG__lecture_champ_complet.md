# TT-ACC-01-B3-013 — Bloc 3 — B3_RMS_Y_MG

## Objectif
Vérifier que le champ logique multi-registres `B3_RMS_Y_MG` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 3020
- Longueur : 2

## Scénario / étapes
1. Lire les registres 3020 à 3021.
...
- le champ `B3_RMS_Y_MG` est lisible conformément au mapping.
