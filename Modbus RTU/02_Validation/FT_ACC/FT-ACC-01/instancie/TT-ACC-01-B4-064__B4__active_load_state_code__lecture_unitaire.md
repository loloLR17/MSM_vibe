# TT-ACC-01-B4-064 — Bloc 4 — active_load_state_code

## Objectif
Vérifier que le champ logique `active_load_state_code` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 4166
- Longueur : 1

## Scénario / étapes
1. Lire le registre 4166.
...
- le champ `active_load_state_code` est lisible conformément au mapping.
