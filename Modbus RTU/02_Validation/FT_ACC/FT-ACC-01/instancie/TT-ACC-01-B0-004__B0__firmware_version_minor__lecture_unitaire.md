# TT-ACC-01-B0-004 — Bloc 0 — firmware_version_minor

## Objectif
Vérifier que le champ logique `firmware_version_minor` déclaré lisible est accessible en lecture unitaire.
...
- le champ `firmware_version_minor` est lisible conformément au mapping.
