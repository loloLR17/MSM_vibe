# TT-ACC-01-B3-023 — Bloc 3 — B3_ALARM_LATCHED

## Objectif
Vérifier que le champ logique `B3_ALARM_LATCHED` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 3035
- Longueur : 1

## Scénario / étapes
1. Lire le registre 3035.
...
- le champ `B3_ALARM_LATCHED` est lisible conformément au mapping.
