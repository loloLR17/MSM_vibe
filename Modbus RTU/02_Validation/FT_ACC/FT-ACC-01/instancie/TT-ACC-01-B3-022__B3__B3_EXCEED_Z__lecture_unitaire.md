# TT-ACC-01-B3-022 — Bloc 3 — B3_EXCEED_Z

## Objectif
Vérifier que le champ logique `B3_EXCEED_Z` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 3034
- Longueur : 1

## Scénario / étapes
1. Lire le registre 3034.
...
- le champ `B3_EXCEED_Z` est lisible conformément au mapping.
