# TT-ACC-01-B4-013 — Bloc 4 — reserved_4B_17

## Objectif
Vérifier que le champ logique `reserved_4B_17` déclaré lisible est accessible en lecture unitaire.
...
- le champ `reserved_4B_17` est lisible conformément au mapping.
