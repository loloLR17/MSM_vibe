# TT-ACC-01-B4-057 — Bloc 4 — reserved_4E_B

## Objectif
Vérifier que le champ logique multi-registres `reserved_4E_B` est accessible en lecture complète sur 5 registres.
...
## Scénario / étapes
1. Lire les registres 4123 à 4127.
...
- le champ `reserved_4E_B` est lisible conformément au mapping.
