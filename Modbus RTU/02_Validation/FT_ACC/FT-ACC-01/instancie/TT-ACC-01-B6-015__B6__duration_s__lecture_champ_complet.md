# TT-ACC-01-B6-015 — Bloc 6 — duration_s

## Objectif
Vérifier que le champ logique multi-registres `duration_s` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 6021
- Longueur : 2

## Scénario / étapes
1. Lire les registres 6021 à 6022.
...
- le champ `duration_s` est lisible conformément au mapping.
