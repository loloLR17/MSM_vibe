# TT-ACC-01-B5-012 — Bloc 5 — cmd_result_detail

## Objectif
Vérifier que le champ logique `cmd_result_detail` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 5012
- Longueur : 1

## Scénario / étapes
1. Lire le registre 5012.
...
- le champ `cmd_result_detail` est lisible conformément au mapping.
