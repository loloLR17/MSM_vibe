# TT-ACC-01-B3-026 — Bloc 3 — B3_RESERVED_0

## Objectif
Vérifier que le champ logique multi-registres `B3_RESERVED_0` est accessible en lecture complète sur 8 registres.
...
## Données d’entrée
- Adresse de départ : 3040
- Longueur : 8

## Scénario / étapes
1. Lire les registres 3040 à 3047.
...
- le champ `B3_RESERVED_0` est lisible conformément au mapping.
