# TT-ACC-01-B4-031 — Bloc 4 — campaign_context_id

## Objectif
Vérifier que le champ logique multi-registres `campaign_context_id` est accessible en lecture complète sur 2 registres.
...
## Scénario / étapes
1. Lire les registres 4056 à 4057.
...
- le champ `campaign_context_id` est lisible conformément au mapping.
