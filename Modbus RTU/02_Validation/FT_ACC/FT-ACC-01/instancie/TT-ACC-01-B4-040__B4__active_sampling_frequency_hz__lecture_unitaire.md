# TT-ACC-01-B4-040 — Bloc 4 — active_sampling_frequency_hz

## Objectif
Vérifier que le champ logique `active_sampling_frequency_hz` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 4100
- Longueur : 1

## Scénario / étapes
1. Lire le registre 4100.
...
- le champ `active_sampling_frequency_hz` est lisible conformément au mapping.
