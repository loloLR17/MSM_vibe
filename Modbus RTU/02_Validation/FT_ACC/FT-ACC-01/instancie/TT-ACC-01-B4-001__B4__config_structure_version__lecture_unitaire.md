# TT-ACC-01-B4-001 — Bloc 4 — config_structure_version

## Objectif
Vérifier que le champ logique `config_structure_version` déclaré lisible est accessible en lecture unitaire.
...
- le champ `config_structure_version` est lisible conformément au mapping.
