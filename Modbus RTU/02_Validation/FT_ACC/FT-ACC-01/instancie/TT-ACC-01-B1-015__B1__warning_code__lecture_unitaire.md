# TT-ACC-01-B1-015 — Bloc 1 — warning_code

## Objectif
Vérifier que le champ logique `warning_code` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 1016
- Longueur : 1

## Scénario / étapes
1. Lire le registre 1016.
...
- le champ `warning_code` est lisible conformément au mapping.
