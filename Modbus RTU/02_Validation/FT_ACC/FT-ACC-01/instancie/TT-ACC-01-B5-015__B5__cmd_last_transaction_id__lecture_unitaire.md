# TT-ACC-01-B5-015 — Bloc 5 — cmd_last_transaction_id

## Objectif
Vérifier que le champ logique `cmd_last_transaction_id` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 5015
- Longueur : 1

## Scénario / étapes
1. Lire le registre 5015.
...
- le champ `cmd_last_transaction_id` est lisible conformément au mapping.
