# TT-ACC-01-B3-011 — Bloc 3 — B3_PEAK_GLOBAL_MG

## Objectif
Vérifier que le champ logique multi-registres `B3_PEAK_GLOBAL_MG` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 3016
- Longueur : 2

## Scénario / étapes
1. Lire les registres 3016 à 3017.
...
- le champ `B3_PEAK_GLOBAL_MG` est lisible conformément au mapping.
