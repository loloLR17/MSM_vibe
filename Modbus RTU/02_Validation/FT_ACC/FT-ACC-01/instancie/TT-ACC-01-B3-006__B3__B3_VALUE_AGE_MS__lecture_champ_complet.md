# TT-ACC-01-B3-006 — Bloc 3 — B3_VALUE_AGE_MS

## Objectif
Vérifier que le champ logique multi-registres `B3_VALUE_AGE_MS` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 3006
- Longueur : 2

## Scénario / étapes
1. Lire les registres 3006 à 3007.
...
- le champ `B3_VALUE_AGE_MS` est lisible conformément au mapping.
