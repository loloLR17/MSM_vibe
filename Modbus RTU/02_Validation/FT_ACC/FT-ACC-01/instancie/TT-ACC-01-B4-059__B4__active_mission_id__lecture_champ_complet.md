# TT-ACC-01-B4-059 — Bloc 4 — active_mission_id

## Objectif
Vérifier que le champ logique multi-registres `active_mission_id` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 4130
- Longueur : 2

## Scénario / étapes
1. Lire les registres 4130 à 4131.
...
- le champ `active_mission_id` est lisible conformément au mapping.
