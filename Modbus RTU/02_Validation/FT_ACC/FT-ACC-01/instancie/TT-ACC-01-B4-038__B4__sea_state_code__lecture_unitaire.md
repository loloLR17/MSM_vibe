# TT-ACC-01-B4-038 — Bloc 4 — sea_state_code

## Objectif
Vérifier que le champ logique `sea_state_code` déclaré lisible est accessible en lecture unitaire.
...
- le champ `sea_state_code` est lisible conformément au mapping.
