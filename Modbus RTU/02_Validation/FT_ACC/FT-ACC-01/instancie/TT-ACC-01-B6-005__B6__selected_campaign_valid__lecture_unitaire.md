# TT-ACC-01-B6-005 — Bloc 6 — selected_campaign_valid

## Objectif
Vérifier que le champ logique `selected_campaign_valid` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 6004
- Longueur : 1

## Scénario / étapes
1. Lire le registre 6004.
...
- le champ `selected_campaign_valid` est lisible conformément au mapping.
