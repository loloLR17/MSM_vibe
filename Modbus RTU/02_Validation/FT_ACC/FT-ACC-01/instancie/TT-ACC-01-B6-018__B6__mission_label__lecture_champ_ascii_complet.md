# TT-ACC-01-B6-018 — Bloc 6 — mission_label

## Objectif
Vérifier que le champ ASCII fixe `mission_label` est accessible en lecture complète sur 16 registres.
...
## Données d’entrée
- Adresse de départ : 6041
- Longueur : 16

## Scénario / étapes
1. Lire les registres 6041 à 6056.
...
- le champ `mission_label` est lisible conformément au mapping.
