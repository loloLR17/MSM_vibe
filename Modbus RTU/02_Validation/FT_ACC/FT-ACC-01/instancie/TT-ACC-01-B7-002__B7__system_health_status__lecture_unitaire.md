# TT-ACC-01-B7-002 — Bloc 7 — system_health_status

## Objectif
Vérifier que le champ logique `system_health_status` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 7001
- Longueur : 1

## Scénario / étapes
1. Lire le registre 7001.
...
- le champ `system_health_status` est lisible conformément au mapping.
