# TT-ACC-01-B3-008 — Bloc 3 — B3_WINDOW_DURATION_MS

## Objectif
Vérifier que le champ logique multi-registres `B3_WINDOW_DURATION_MS` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 3010
- Longueur : 2

## Scénario / étapes
1. Lire les registres 3010 à 3011.
...
- le champ `B3_WINDOW_DURATION_MS` est lisible conformément au mapping.
