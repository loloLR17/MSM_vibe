# TT-ACC-01-B1-003 — Bloc 1 — fault_flags

## Objectif
Vérifier que le champ logique `fault_flags` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 1002
- Longueur : 1

## Scénario / étapes
1. Lire le registre 1002.
...
- le champ `fault_flags` est lisible conformément au mapping.
