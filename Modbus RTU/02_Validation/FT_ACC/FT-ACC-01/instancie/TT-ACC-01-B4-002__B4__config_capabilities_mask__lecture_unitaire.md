# TT-ACC-01-B4-002 — Bloc 4 — config_capabilities_mask

## Objectif
Vérifier que le champ logique `config_capabilities_mask` déclaré lisible est accessible en lecture unitaire.
...
- le champ `config_capabilities_mask` est lisible conformément au mapping.
