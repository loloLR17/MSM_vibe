# TT-ACC-01-B0-005 — Bloc 0 — firmware_version_patch

## Objectif
Vérifier que le champ logique `firmware_version_patch` déclaré lisible est accessible en lecture unitaire.
...
- le champ `firmware_version_patch` est lisible conformément au mapping.
