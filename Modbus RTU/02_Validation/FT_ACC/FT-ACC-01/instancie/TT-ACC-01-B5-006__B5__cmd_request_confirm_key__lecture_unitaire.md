# TT-ACC-01-B5-006 — Bloc 5 — cmd_request_confirm_key

## Objectif
Vérifier que le champ logique `cmd_request_confirm_key` déclaré lisible est accessible en lecture unitaire.
...
- le champ `cmd_request_confirm_key` est lisible conformément au mapping.
