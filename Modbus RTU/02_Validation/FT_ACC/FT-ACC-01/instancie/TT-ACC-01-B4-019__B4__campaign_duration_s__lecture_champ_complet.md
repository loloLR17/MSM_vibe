# TT-ACC-01-B4-019 — Bloc 4 — campaign_duration_s

## Objectif
Vérifier que le champ logique multi-registres `campaign_duration_s` est accessible en lecture complète sur 2 registres.
...
## Scénario / étapes
1. Lire les registres 4023 à 4024.
...
- le champ `campaign_duration_s` est lisible conformément au mapping.
