# TT-ACC-01-B6-008 — Bloc 6 — storage_health_status

## Objectif
Vérifier que le champ logique `storage_health_status` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 6009
- Longueur : 1

## Scénario / étapes
1. Lire le registre 6009.
...
- le champ `storage_health_status` est lisible conformément au mapping.
