# TT-ACC-01-GEN-002 — Lecture registre début de plage lisible

## Objectif
Vérifier qu’un registre situé en début d’une plage lisible est accessible en lecture.
...
## Type de test
Nominal / limite (frontière basse de plage)
