# TT-ACC-01-GEN-004 — Lecture registre fin de plage lisible

## Objectif
Vérifier qu’un registre situé en fin d’une plage lisible est accessible en lecture.
...
## Type de test
Nominal / limite (frontière haute de plage)
