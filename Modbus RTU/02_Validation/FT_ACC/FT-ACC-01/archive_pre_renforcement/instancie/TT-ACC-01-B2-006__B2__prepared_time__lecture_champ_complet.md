# TT-ACC-01-B2-006 — Bloc 2 — prepared_time

## Objectif
Vérifier que le champ logique multi-registres `prepared_time` est accessible en lecture complète sur 2 registres.
...
## Scénario / étapes
1. Lire les registres 2008 à 2009.
...
- le champ `prepared_time` est lisible conformément au mapping.
