# TT-ACC-01-B4-043 — Bloc 4 — active_acquisition_mode

## Objectif
Vérifier que le champ logique `active_acquisition_mode` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 4103
- Longueur : 1

## Scénario / étapes
1. Lire le registre 4103.
...
- le champ `active_acquisition_mode` est lisible conformément au mapping.
