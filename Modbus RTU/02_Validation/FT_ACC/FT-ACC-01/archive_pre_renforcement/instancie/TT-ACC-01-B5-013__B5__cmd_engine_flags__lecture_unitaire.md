# TT-ACC-01-B5-013 — Bloc 5 — cmd_engine_flags

## Objectif
Vérifier que le champ logique `cmd_engine_flags` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 5013
- Longueur : 1

## Scénario / étapes
1. Lire le registre 5013.
...
- le champ `cmd_engine_flags` est lisible conformément au mapping.
