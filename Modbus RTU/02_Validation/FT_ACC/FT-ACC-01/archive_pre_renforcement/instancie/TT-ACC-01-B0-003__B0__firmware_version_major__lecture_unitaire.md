# TT-ACC-01-B0-003 — Bloc 0 — firmware_version_major

## Objectif
Vérifier que le champ logique `firmware_version_major` déclaré lisible est accessible en lecture unitaire.
...
- le champ `firmware_version_major` est lisible conformément au mapping.
