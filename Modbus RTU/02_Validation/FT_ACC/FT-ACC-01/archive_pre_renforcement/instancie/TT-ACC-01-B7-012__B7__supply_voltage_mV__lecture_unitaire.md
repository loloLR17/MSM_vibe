# TT-ACC-01-B7-012 — Bloc 7 — supply_voltage_mV

## Objectif
Vérifier que le champ logique `supply_voltage_mV` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 7013
- Longueur : 1

## Scénario / étapes
1. Lire le registre 7013.
...
- le champ `supply_voltage_mV` est lisible conformément au mapping.
