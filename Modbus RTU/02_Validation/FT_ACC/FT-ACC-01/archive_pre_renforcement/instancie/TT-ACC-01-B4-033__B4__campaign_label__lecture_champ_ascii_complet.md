# TT-ACC-01-B4-033 — Bloc 4 — campaign_label

## Objectif
Vérifier que le champ ASCII fixe `campaign_label` est accessible en lecture complète sur 16 registres.
...
## Scénario / étapes
1. Lire les registres 4060 à 4075.
...
- le champ `campaign_label` est lisible conformément au mapping.
