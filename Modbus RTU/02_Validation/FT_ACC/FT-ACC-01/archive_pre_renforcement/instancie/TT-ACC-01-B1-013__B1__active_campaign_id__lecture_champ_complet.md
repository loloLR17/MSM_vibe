# TT-ACC-01-B1-013 — Bloc 1 — active_campaign_id

## Objectif
Vérifier que le champ logique multi-registres `active_campaign_id` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 1013
- Longueur : 2

## Scénario / étapes
1. Lire les registres 1013 à 1014.
...
- le champ `active_campaign_id` est lisible conformément au mapping.
