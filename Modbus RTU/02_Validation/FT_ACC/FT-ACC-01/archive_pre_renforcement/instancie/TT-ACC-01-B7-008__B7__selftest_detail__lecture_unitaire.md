# TT-ACC-01-B7-008 — Bloc 7 — selftest_detail

## Objectif
Vérifier que le champ logique `selftest_detail` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 7008
- Longueur : 1

## Scénario / étapes
1. Lire le registre 7008.
...
- le champ `selftest_detail` est lisible conformément au mapping.
