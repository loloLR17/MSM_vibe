# TT-ACC-01-B4-027 — Bloc 4 — peak_alarm_threshold_mg

## Objectif
Vérifier que le champ logique `peak_alarm_threshold_mg` déclaré lisible est accessible en lecture unitaire.
...
- le champ `peak_alarm_threshold_mg` est lisible conformément au mapping.
