# TT-ACC-01-B1-017 — Bloc 1 — reserved_2

## Objectif
Vérifier que le champ logique `reserved_2` déclaré lisible est accessible en lecture unitaire.
...
- le champ `reserved_2` est lisible conformément au mapping.
