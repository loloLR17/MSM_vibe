# TT-ACC-01-B4-007 — Bloc 4 — prepared_config_crc

## Objectif
Vérifier que le champ logique multi-registres `prepared_config_crc` est accessible en lecture complète sur 2 registres.
...
## Scénario / étapes
1. Lire les registres 4008 à 4009.
...
- le champ `prepared_config_crc` est lisible conformément au mapping.
