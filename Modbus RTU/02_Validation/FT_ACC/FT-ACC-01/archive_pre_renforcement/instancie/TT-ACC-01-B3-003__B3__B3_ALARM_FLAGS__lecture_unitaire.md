# TT-ACC-01-B3-003 — Bloc 3 — B3_ALARM_FLAGS

## Objectif
Vérifier que le champ logique `B3_ALARM_FLAGS` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 3002
- Longueur : 1

## Scénario / étapes
1. Lire le registre 3002.
...
- le champ `B3_ALARM_FLAGS` est lisible conformément au mapping.
