# TT-ACC-01-B6-002 — Bloc 6 — total_campaign_count

## Objectif
Vérifier que le champ logique `total_campaign_count` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 6001
- Longueur : 1

## Scénario / étapes
1. Lire le registre 6001.
...
- le champ `total_campaign_count` est lisible conformément au mapping.
