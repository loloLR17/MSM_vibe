# TT-ACC-01-B4-036 — Bloc 4 — navigation_zone_code

## Objectif
Vérifier que le champ logique `navigation_zone_code` déclaré lisible est accessible en lecture unitaire.
...
- le champ `navigation_zone_code` est lisible conformément au mapping.
