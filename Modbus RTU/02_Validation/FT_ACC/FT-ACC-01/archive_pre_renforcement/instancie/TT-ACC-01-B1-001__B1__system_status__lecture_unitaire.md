# TT-ACC-01-B1-001 — Bloc 1 — system_status

## Objectif
Vérifier que le champ logique `system_status` déclaré lisible est accessible en lecture unitaire.
...
- le champ `system_status` est lisible conformément au mapping.
