# TT-ACC-01-B5-016 — Bloc 5 — cmd_last_status_final

## Objectif
Vérifier que le champ logique `cmd_last_status_final` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 5016
- Longueur : 1

## Scénario / étapes
1. Lire le registre 5016.
...
- le champ `cmd_last_status_final` est lisible conformément au mapping.
