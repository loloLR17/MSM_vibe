# TT-ACC-01-B5-007 — Bloc 5 — cmd_request_control

## Objectif
Vérifier que le champ logique `cmd_request_control` déclaré lisible est accessible en lecture unitaire.
...
- le champ `cmd_request_control` est lisible conformément au mapping.
