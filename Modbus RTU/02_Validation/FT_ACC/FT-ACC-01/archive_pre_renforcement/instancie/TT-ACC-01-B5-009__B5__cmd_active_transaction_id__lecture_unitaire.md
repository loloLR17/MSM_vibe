# TT-ACC-01-B5-009 — Bloc 5 — cmd_active_transaction_id

## Objectif
Vérifier que le champ logique `cmd_active_transaction_id` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 5009
- Longueur : 1

## Scénario / étapes
1. Lire le registre 5009.
...
- le champ `cmd_active_transaction_id` est lisible conformément au mapping.
