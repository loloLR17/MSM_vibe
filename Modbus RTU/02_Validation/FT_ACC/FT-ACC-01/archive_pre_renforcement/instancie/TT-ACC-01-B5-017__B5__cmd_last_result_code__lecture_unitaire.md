# TT-ACC-01-B5-017 — Bloc 5 — cmd_last_result_code

## Objectif
Vérifier que le champ logique `cmd_last_result_code` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 5017
- Longueur : 1

## Scénario / étapes
1. Lire le registre 5017.
...
- le champ `cmd_last_result_code` est lisible conformément au mapping.
