# TT-ACC-01-B4-025 — Bloc 4 — rms_alarm_threshold_mg

## Objectif
Vérifier que le champ logique `rms_alarm_threshold_mg` déclaré lisible est accessible en lecture unitaire.
...
- le champ `rms_alarm_threshold_mg` est lisible conformément au mapping.
