# TT-ACC-01-B0-001 — Bloc 0 — device_id

## Objectif
Vérifier que le champ logique multi-registres `device_id` est accessible en lecture complète sur 2 registres.
...
- le champ `device_id` est lisible conformément au mapping.
