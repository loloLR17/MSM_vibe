# TT-ACC-01-B4-009 — Bloc 4 — config_revision_counter

## Objectif
Vérifier que le champ logique multi-registres `config_revision_counter` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 4012
- Longueur : 2

## Scénario / étapes
1. Lire les registres 4012 à 4013.
...
- le champ `config_revision_counter` est lisible conformément au mapping.
