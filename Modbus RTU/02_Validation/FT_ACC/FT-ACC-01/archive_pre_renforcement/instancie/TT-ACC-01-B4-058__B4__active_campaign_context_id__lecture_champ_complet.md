# TT-ACC-01-B4-058 — Bloc 4 — active_campaign_context_id

## Objectif
Vérifier que le champ logique multi-registres `active_campaign_context_id` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 4128
- Longueur : 2

## Scénario / étapes
1. Lire les registres 4128 à 4129.
...
- le champ `active_campaign_context_id` est lisible conformément au mapping.
