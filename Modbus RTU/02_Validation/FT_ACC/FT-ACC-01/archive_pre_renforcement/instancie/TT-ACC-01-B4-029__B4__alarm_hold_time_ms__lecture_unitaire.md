# TT-ACC-01-B4-029 — Bloc 4 — alarm_hold_time_ms

## Objectif
Vérifier que le champ logique `alarm_hold_time_ms` déclaré lisible est accessible en lecture unitaire.
...
- le champ `alarm_hold_time_ms` est lisible conformément au mapping.
