# TT-ACC-01-B4-016 — Bloc 4 — acquisition_mode

## Objectif
Vérifier que le champ logique `acquisition_mode` déclaré lisible est accessible en lecture unitaire.
...
- le champ `acquisition_mode` est lisible conformément au mapping.
