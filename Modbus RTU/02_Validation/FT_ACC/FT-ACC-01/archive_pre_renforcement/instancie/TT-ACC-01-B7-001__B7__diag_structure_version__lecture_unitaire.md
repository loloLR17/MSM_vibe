# TT-ACC-01-B7-001 — Bloc 7 — diag_structure_version

## Objectif
Vérifier que le champ logique `diag_structure_version` déclaré lisible est accessible en lecture unitaire.
...
- le champ `diag_structure_version` est lisible conformément au mapping.
