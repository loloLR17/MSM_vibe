# TT-ACC-01-B6-007 — Bloc 6 — storage_free_mb

## Objectif
Vérifier que le champ logique multi-registres `storage_free_mb` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 6007
- Longueur : 2

## Scénario / étapes
1. Lire les registres 6007 à 6008.
...
- le champ `storage_free_mb` est lisible conformément au mapping.
