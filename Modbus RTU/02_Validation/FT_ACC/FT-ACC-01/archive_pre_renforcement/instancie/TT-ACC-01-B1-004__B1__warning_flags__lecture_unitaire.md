# TT-ACC-01-B1-004 — Bloc 1 — warning_flags

## Objectif
Vérifier que le champ logique `warning_flags` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 1003
- Longueur : 1

## Scénario / étapes
1. Lire le registre 1003.
...
- le champ `warning_flags` est lisible conformément au mapping.
