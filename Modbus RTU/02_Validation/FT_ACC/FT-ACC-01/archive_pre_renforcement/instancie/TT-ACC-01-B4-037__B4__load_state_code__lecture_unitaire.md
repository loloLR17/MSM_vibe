# TT-ACC-01-B4-037 — Bloc 4 — load_state_code

## Objectif
Vérifier que le champ logique `load_state_code` déclaré lisible est accessible en lecture unitaire.
...
- le champ `load_state_code` est lisible conformément au mapping.
