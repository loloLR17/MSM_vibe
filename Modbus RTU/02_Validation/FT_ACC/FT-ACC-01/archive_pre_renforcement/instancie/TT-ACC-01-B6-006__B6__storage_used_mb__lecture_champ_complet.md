# TT-ACC-01-B6-006 — Bloc 6 — storage_used_mb

## Objectif
Vérifier que le champ logique multi-registres `storage_used_mb` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 6005
- Longueur : 2

## Scénario / étapes
1. Lire les registres 6005 à 6006.
...
- le champ `storage_used_mb` est lisible conformément au mapping.
