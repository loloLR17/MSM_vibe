# TT-ACC-01-B4-028 — Bloc 4 — threshold_hysteresis_mg

## Objectif
Vérifier que le champ logique `threshold_hysteresis_mg` déclaré lisible est accessible en lecture unitaire.
...
- le champ `threshold_hysteresis_mg` est lisible conformément au mapping.
