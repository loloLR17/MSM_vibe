# TT-ACC-01-B7-007 — Bloc 7 — selftest_result_code

## Objectif
Vérifier que le champ logique `selftest_result_code` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 7007
- Longueur : 1

## Scénario / étapes
1. Lire le registre 7007.
...
- le champ `selftest_result_code` est lisible conformément au mapping.
