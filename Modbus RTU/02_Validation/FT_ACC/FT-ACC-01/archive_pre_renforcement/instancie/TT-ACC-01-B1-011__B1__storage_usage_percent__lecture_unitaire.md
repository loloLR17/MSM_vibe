# TT-ACC-01-B1-011 — Bloc 1 — storage_usage_percent

## Objectif
Vérifier que le champ logique `storage_usage_percent` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 1011
- Longueur : 1

## Scénario / étapes
1. Lire le registre 1011.
...
- le champ `storage_usage_percent` est lisible conformément au mapping.
