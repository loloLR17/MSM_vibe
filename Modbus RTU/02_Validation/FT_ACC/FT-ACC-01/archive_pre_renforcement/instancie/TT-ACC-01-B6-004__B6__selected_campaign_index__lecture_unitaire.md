# TT-ACC-01-B6-004 — Bloc 6 — selected_campaign_index

## Objectif
Vérifier que le champ logique `selected_campaign_index` déclaré lisible est accessible en lecture unitaire.
...
- le champ `selected_campaign_index` est lisible conformément au mapping.
