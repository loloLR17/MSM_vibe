# TT-ACC-01-B5-014 — Bloc 5 — cmd_last_code

## Objectif
Vérifier que le champ logique `cmd_last_code` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 5014
- Longueur : 1

## Scénario / étapes
1. Lire le registre 5014.
...
- le champ `cmd_last_code` est lisible conformément au mapping.
