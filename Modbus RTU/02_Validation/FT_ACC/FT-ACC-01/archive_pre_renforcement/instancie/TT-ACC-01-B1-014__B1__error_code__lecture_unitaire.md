# TT-ACC-01-B1-014 — Bloc 1 — error_code

## Objectif
Vérifier que le champ logique `error_code` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 1015
- Longueur : 1

## Scénario / étapes
1. Lire le registre 1015.
...
- le champ `error_code` est lisible conformément au mapping.
