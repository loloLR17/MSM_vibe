# TT-ACC-01-B1-009 — Bloc 1 — memory_usage_percent

## Objectif
Vérifier que le champ logique `memory_usage_percent` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 1009
- Longueur : 1

## Scénario / étapes
1. Lire le registre 1009.
...
- le champ `memory_usage_percent` est lisible conformément au mapping.
