# TT-ACC-01-B3-001 — Bloc 3 — B3_STATUS_GLOBAL

## Objectif
Vérifier que le champ logique `B3_STATUS_GLOBAL` déclaré lisible est accessible en lecture unitaire.
...
- le champ `B3_STATUS_GLOBAL` est lisible conformément au mapping.
