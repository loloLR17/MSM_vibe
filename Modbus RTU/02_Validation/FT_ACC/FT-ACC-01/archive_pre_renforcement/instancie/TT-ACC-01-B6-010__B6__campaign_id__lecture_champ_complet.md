# TT-ACC-01-B6-010 — Bloc 6 — campaign_id

## Objectif
Vérifier que le champ logique multi-registres `campaign_id` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 6012
- Longueur : 2

## Scénario / étapes
1. Lire les registres 6012 à 6013.
...
- le champ `campaign_id` est lisible conformément au mapping.
