# TT-ACC-01-B4-005 — Bloc 4 — config_state

## Objectif
Vérifier que le champ logique `config_state` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 4006
- Longueur : 1

## Scénario / étapes
1. Lire le registre 4006.
...
- le champ `config_state` est lisible conformément au mapping.
