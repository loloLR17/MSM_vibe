# TT-ACC-01-B4-053 — Bloc 4 — active_peak_warn_threshold_mg

## Objectif
Vérifier que le champ logique `active_peak_warn_threshold_mg` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 4119
- Longueur : 1

## Scénario / étapes
1. Lire le registre 4119.
...
- le champ `active_peak_warn_threshold_mg` est lisible conformément au mapping.
