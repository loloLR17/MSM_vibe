# TT-ACC-01-B4-055 — Bloc 4 — active_threshold_hysteresis_mg

## Objectif
Vérifier que le champ logique `active_threshold_hysteresis_mg` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 4121
- Longueur : 1

## Scénario / étapes
1. Lire le registre 4121.
...
- le champ `active_threshold_hysteresis_mg` est lisible conformément au mapping.
