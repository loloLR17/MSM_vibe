# TT-ACC-01-B4-044 — Bloc 4 — active_window_size_samples

## Objectif
Vérifier que le champ logique `active_window_size_samples` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 4104
- Longueur : 1

## Scénario / étapes
1. Lire le registre 4104.
...
- le champ `active_window_size_samples` est lisible conformément au mapping.
