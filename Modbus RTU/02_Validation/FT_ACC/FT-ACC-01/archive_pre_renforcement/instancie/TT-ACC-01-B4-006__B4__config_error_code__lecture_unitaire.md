# TT-ACC-01-B4-006 — Bloc 4 — config_error_code

## Objectif
Vérifier que le champ logique `config_error_code` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 4007
- Longueur : 1

## Scénario / étapes
1. Lire le registre 4007.
...
- le champ `config_error_code` est lisible conformément au mapping.
