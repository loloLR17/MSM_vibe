# TT-ACC-01-B4-018 — Bloc 4 — indicator_period_ms

## Objectif
Vérifier que le champ logique `indicator_period_ms` déclaré lisible est accessible en lecture unitaire.
...
- le champ `indicator_period_ms` est lisible conformément au mapping.
