# TT-ACC-01-B4-060 — Bloc 4 — active_campaign_label

## Objectif
Vérifier que le champ ASCII fixe `active_campaign_label` est accessible en lecture complète sur 16 registres.
...
## Données d’entrée
- Adresse de départ : 4132
- Longueur : 16

## Scénario / étapes
1. Lire les registres 4132 à 4147.
...
- la réponse contient exactement 16 registre(s) ;
- le champ `active_campaign_label` est lisible conformément au mapping.
