# TT-ACC-01-B4-046 — Bloc 4 — active_campaign_duration_s

## Objectif
Vérifier que le champ logique multi-registres `active_campaign_duration_s` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 4106
- Longueur : 2

## Scénario / étapes
1. Lire les registres 4106 à 4107.
...
- le champ `active_campaign_duration_s` est lisible conformément au mapping.
