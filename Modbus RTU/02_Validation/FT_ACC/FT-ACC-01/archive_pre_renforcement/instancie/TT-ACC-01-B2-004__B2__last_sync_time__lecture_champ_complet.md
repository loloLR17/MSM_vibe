# TT-ACC-01-B2-004 — Bloc 2 — last_sync_time

## Objectif
Vérifier que le champ logique multi-registres `last_sync_time` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 2004
- Longueur : 2

## Scénario / étapes
1. Lire les registres 2004 à 2005.
...
- le champ `last_sync_time` est lisible conformément au mapping.
