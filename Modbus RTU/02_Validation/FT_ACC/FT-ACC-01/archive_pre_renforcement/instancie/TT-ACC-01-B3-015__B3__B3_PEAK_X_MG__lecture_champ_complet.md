# TT-ACC-01-B3-015 — Bloc 3 — B3_PEAK_X_MG

## Objectif
Vérifier que le champ logique multi-registres `B3_PEAK_X_MG` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 3024
- Longueur : 2

## Scénario / étapes
1. Lire les registres 3024 à 3025.
...
- le champ `B3_PEAK_X_MG` est lisible conformément au mapping.
