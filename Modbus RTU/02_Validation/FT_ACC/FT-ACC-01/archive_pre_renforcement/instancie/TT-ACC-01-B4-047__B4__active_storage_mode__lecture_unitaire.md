# TT-ACC-01-B4-047 — Bloc 4 — active_storage_mode

## Objectif
Vérifier que le champ logique `active_storage_mode` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 4108
- Longueur : 1

## Scénario / étapes
1. Lire le registre 4108.
...
- le champ `active_storage_mode` est lisible conformément au mapping.
