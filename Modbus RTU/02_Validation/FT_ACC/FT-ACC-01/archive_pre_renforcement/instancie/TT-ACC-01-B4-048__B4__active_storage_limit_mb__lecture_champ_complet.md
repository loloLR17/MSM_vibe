# TT-ACC-01-B4-048 — Bloc 4 — active_storage_limit_mb

## Objectif
Vérifier que le champ logique multi-registres `active_storage_limit_mb` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 4109
- Longueur : 2

## Scénario / étapes
1. Lire les registres 4109 à 4110.
...
- le champ `active_storage_limit_mb` est lisible conformément au mapping.
