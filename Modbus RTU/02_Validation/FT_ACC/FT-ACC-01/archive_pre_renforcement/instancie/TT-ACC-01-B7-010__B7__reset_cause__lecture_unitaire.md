# TT-ACC-01-B7-010 — Bloc 7 — reset_cause

## Objectif
Vérifier que le champ logique `reset_cause` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 7011
- Longueur : 1

## Scénario / étapes
1. Lire le registre 7011.
...
- le champ `reset_cause` est lisible conformément au mapping.
