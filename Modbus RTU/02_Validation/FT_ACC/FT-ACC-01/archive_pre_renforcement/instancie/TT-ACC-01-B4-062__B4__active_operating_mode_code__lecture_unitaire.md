# TT-ACC-01-B4-062 — Bloc 4 — active_operating_mode_code

## Objectif
Vérifier que le champ logique `active_operating_mode_code` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 4164
- Longueur : 1

## Scénario / étapes
1. Lire le registre 4164.
...
- le champ `active_operating_mode_code` est lisible conformément au mapping.
