# TT-ACC-01-B4-003 — Bloc 4 — prepared_config_id

## Objectif
Vérifier que le champ logique multi-registres `prepared_config_id` est accessible en lecture complète sur 2 registres.
...
## Scénario / étapes
1. Lire les registres 4002 à 4003.
...
- le champ `prepared_config_id` est lisible conformément au mapping.
