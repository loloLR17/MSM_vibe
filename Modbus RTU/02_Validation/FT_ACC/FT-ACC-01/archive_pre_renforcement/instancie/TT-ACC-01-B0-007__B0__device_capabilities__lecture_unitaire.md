# TT-ACC-01-B0-007 — Bloc 0 — device_capabilities

## Objectif
Vérifier que le champ logique `device_capabilities` déclaré lisible est accessible en lecture unitaire.
...
- le champ `device_capabilities` est lisible conformément au mapping.
