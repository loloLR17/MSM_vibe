# TT-ACC-01-B5-002 — Bloc 5 — cmd_request_transaction_id

## Objectif
Vérifier que le champ logique `cmd_request_transaction_id` déclaré lisible est accessible en lecture unitaire.
...
- le champ `cmd_request_transaction_id` est lisible conformément au mapping.
