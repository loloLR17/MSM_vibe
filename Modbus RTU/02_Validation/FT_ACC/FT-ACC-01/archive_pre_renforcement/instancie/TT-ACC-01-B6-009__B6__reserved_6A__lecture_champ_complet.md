# TT-ACC-01-B6-009 — Bloc 6 — reserved_6A

## Objectif
Vérifier que le champ logique multi-registres `reserved_6A` est accessible en lecture complète sur 2 registres.
...
## Scénario / étapes
1. Lire les registres 6010 à 6011.
...
- le champ `reserved_6A` est lisible conformément au mapping.
