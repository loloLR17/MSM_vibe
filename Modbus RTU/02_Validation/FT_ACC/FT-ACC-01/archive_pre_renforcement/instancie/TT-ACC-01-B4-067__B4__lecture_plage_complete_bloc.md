# TT-ACC-01-B4-067 — Bloc 4 — lecture_plage_complete_bloc

## Objectif
Vérifier que la plage complète couverte du bloc 4 est accessible en lecture multi-registres sans erreur.
...
- Adresse début : 4000
- Adresse fin : 4175
- Couverture continue : 176 registres
...
## Données d’entrée
- Adresse de départ : 4000
- Longueur : 176

## Scénario / étapes
1. Lire la plage complète du bloc 4, du registre 4000 au registre 4175.
2. Contrôler l’absence d’exception Modbus.
3. Vérifier que la réponse contient exactement 176 registres.
...
- la plage complète documentée du bloc 4 est lisible.
