# TT-ACC-01-B4-065 — Bloc 4 — active_sea_state_code

## Objectif
Vérifier que le champ logique `active_sea_state_code` déclaré lisible est accessible en lecture unitaire.
...
- le champ `active_sea_state_code` est lisible conformément au mapping.
