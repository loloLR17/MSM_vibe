# TT-ACC-01-B4-035 — Bloc 4 — operating_mode_code

## Objectif
Vérifier que le champ logique `operating_mode_code` déclaré lisible est accessible en lecture unitaire.
...
- le champ `operating_mode_code` est lisible conformément au mapping.
