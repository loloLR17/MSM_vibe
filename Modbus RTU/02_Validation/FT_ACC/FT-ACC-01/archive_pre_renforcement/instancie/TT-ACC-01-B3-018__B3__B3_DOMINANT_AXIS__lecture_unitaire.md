# TT-ACC-01-B3-018 — Bloc 3 — B3_DOMINANT_AXIS

## Objectif
Vérifier que le champ logique `B3_DOMINANT_AXIS` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 3030
- Longueur : 1

## Scénario / étapes
1. Lire le registre 3030.
...
- le champ `B3_DOMINANT_AXIS` est lisible conformément au mapping.
