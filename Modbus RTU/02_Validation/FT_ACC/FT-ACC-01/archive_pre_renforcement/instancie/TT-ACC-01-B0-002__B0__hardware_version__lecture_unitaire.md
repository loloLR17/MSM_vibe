# TT-ACC-01-B0-002 — Bloc 0 — hardware_version

## Objectif
Vérifier que le champ logique `hardware_version` déclaré lisible est accessible en lecture unitaire.
...
- le champ `hardware_version` est lisible conformément au mapping.
