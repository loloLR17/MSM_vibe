# TT-ACC-01-B3-014 — Bloc 3 — B3_RMS_Z_MG

## Objectif
Vérifier que le champ logique multi-registres `B3_RMS_Z_MG` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 3022
- Longueur : 2

## Scénario / étapes
1. Lire les registres 3022 à 3023.
...
- le champ `B3_RMS_Z_MG` est lisible conformément au mapping.
