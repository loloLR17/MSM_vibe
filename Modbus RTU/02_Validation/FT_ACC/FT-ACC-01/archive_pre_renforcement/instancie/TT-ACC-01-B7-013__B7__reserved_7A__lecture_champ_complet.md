# TT-ACC-01-B7-013 — Bloc 7 — reserved_7A

## Objectif
Vérifier que le champ logique multi-registres `reserved_7A` est accessible en lecture complète sur 2 registres.
...
## Scénario / étapes
1. Lire les registres 7014 à 7015.
...
- le champ `reserved_7A` est lisible conformément au mapping.
