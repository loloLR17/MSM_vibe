# TT-ACC-01-B7-004 — Bloc 7 — last_fault_code

## Objectif
Vérifier que le champ logique `last_fault_code` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 7003
- Longueur : 1

## Scénario / étapes
1. Lire le registre 7003.
...
- le champ `last_fault_code` est lisible conformément au mapping.
