# TT-ACC-01-B2-008 — Bloc 2 — time_accuracy_ms

## Objectif
Vérifier que le champ logique `time_accuracy_ms` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 2011
- Longueur : 1

## Scénario / étapes
1. Lire le registre 2011.
...
- le champ `time_accuracy_ms` est lisible conformément au mapping.
