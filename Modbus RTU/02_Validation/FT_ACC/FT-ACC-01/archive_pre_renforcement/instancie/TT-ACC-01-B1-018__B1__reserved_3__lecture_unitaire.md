# TT-ACC-01-B1-018 — Bloc 1 — reserved_3

## Objectif
Vérifier que le champ logique `reserved_3` déclaré lisible est accessible en lecture unitaire.
...
- le champ `reserved_3` est lisible conformément au mapping.
