# TT-ACC-01-B4-066 — Bloc 4 — reserved_4E_C

## Objectif
Vérifier que le champ logique multi-registres `reserved_4E_C` est accessible en lecture complète sur 8 registres.
...
## Scénario / étapes
1. Lire les registres 4168 à 4175.
...
- le champ `reserved_4E_C` est lisible conformément au mapping.
