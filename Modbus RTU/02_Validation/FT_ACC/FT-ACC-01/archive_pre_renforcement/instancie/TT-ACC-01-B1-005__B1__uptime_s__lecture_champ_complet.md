# TT-ACC-01-B1-005 — Bloc 1 — uptime_s

## Objectif
Vérifier que le champ logique multi-registres `uptime_s` est accessible en lecture complète sur 2 registres.
...
## Données d’entrée
- Adresse de départ : 1004
- Longueur : 2

## Scénario / étapes
1. Lire les registres 1004 à 1005.
...
- le champ `uptime_s` est lisible conformément au mapping.
