# TT-ACC-01-B5-010 — Bloc 5 — cmd_status

## Objectif
Vérifier que le champ logique `cmd_status` déclaré lisible est accessible en lecture unitaire.
...
## Données d’entrée
- Adresse de départ : 5010
- Longueur : 1

## Scénario / étapes
1. Lire le registre 5010.
...
- le champ `cmd_status` est lisible conformément au mapping.
