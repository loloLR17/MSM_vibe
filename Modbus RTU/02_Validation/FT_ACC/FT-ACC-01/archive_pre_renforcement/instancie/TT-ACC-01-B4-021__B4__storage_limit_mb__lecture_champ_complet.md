# TT-ACC-01-B4-021 — Bloc 4 — storage_limit_mb

## Objectif
Vérifier que le champ logique multi-registres `storage_limit_mb` est accessible en lecture complète sur 2 registres.
...
## Scénario / étapes
1. Lire les registres 4026 à 4027.
...
- le champ `storage_limit_mb` est lisible conformément au mapping.
