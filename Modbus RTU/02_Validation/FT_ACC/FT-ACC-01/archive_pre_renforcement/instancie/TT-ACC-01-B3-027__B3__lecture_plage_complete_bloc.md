# TT-ACC-01-B3-027 — Bloc 3 — lecture_plage_complete_bloc

## Objectif
Vérifier que la plage complète couverte du bloc 3 est accessible en lecture multi-registres sans erreur.
...
- Adresse début : 3000
- Adresse fin : 3047
- Couverture continue : 48 registres
...
## Données d’entrée
- Adresse de départ : 3000
- Longueur : 48

## Scénario / étapes
1. Lire la plage complète du bloc 3, du registre 3000 au registre 3047.
2. Contrôler l’absence d’exception Modbus.
3. Vérifier que la réponse contient exactement 48 registres.
...
- la plage complète documentée du bloc 3 est lisible.
