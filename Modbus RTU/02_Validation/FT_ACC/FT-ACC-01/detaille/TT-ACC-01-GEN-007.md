# TT-ACC-01-GEN-007 — Lecture couvrant plusieurs types de champs

## Objectif
Valider une lecture d’une plage incluant différents types logiques tout en restant dans une zone lisible.
