# TT-ACC-01-GEN-001 — Lecture registre unitaire lisible

## Objectif
Vérifier qu’un registre déclaré lisible dans le mapping est accessible en lecture unitaire via Modbus.
