# TT-ACC-07-B4-053 — Bloc 4 — active_peak_warn_threshold_mg

## Objectif
Vérifier que le comportement observé du champ `active_peak_warn_threshold_mg` est strictement conforme au mapping.
