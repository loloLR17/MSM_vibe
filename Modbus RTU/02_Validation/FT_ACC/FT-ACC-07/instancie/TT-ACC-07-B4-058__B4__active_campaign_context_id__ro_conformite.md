# TT-ACC-07-B4-058 — Bloc 4 — active_campaign_context_id

## Objectif
Vérifier que le comportement observé du champ `active_campaign_context_id` est strictement conforme au mapping.
