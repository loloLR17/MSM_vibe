# TT-ACC-07-B4-041 — Bloc 4 — active_axes_enable_mask

## Objectif
Vérifier que le comportement observé du champ `active_axes_enable_mask` est strictement conforme au mapping.
