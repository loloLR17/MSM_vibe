# TT-ACC-07-B4-044 — Bloc 4 — active_window_size_samples

## Objectif
Vérifier que le comportement observé du champ `active_window_size_samples` est strictement conforme au mapping.
