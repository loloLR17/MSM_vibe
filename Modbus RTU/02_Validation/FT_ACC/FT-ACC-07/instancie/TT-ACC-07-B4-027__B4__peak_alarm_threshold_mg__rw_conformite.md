# TT-ACC-07-B4-027 — Bloc 4 — peak_alarm_threshold_mg

## Objectif
Vérifier que le comportement observé du champ `peak_alarm_threshold_mg` est strictement conforme au mapping.
