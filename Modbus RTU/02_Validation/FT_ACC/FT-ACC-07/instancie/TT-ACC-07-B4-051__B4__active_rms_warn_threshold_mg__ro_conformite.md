# TT-ACC-07-B4-051 — Bloc 4 — active_rms_warn_threshold_mg

## Objectif
Vérifier que le comportement observé du champ `active_rms_warn_threshold_mg` est strictement conforme au mapping.
