# TT-ACC-07-B4-062 — Bloc 4 — active_operating_mode_code

## Objectif
Vérifier que le comportement observé du champ `active_operating_mode_code` est strictement conforme au mapping.
