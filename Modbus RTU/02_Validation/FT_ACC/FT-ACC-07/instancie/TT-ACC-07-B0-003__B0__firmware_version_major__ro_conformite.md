# TT-ACC-07-B0-003 — Bloc 0 — firmware_version_major

## Objectif
Vérifier que le comportement observé du champ `firmware_version_major` est strictement conforme au mapping.
