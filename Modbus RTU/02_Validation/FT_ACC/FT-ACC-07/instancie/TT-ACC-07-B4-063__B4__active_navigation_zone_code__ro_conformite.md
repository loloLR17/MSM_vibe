# TT-ACC-07-B4-063 — Bloc 4 — active_navigation_zone_code

## Objectif
Vérifier que le comportement observé du champ `active_navigation_zone_code` est strictement conforme au mapping.
