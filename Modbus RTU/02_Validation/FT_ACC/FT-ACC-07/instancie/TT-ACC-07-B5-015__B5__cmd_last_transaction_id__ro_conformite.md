# TT-ACC-07-B5-015 — Bloc 5 — cmd_last_transaction_id

## Objectif
Vérifier que le comportement observé du champ `cmd_last_transaction_id` est strictement conforme au mapping.
