# TT-ACC-07-B4-009 — Bloc 4 — config_revision_counter

## Objectif
Vérifier que le comportement observé du champ `config_revision_counter` est strictement conforme au mapping.
