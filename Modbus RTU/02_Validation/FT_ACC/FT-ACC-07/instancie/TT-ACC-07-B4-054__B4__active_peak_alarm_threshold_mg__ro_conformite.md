# TT-ACC-07-B4-054 — Bloc 4 — active_peak_alarm_threshold_mg

## Objectif
Vérifier que le comportement observé du champ `active_peak_alarm_threshold_mg` est strictement conforme au mapping.
