# TT-ACC-07-B4-002 — Bloc 4 — config_capabilities_mask

## Objectif
Vérifier que le comportement observé du champ `config_capabilities_mask` est strictement conforme au mapping.
