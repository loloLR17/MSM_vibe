# TT-ACC-07-B4-046 — Bloc 4 — active_campaign_duration_s

## Objectif
Vérifier que le comportement observé du champ `active_campaign_duration_s` est strictement conforme au mapping.
