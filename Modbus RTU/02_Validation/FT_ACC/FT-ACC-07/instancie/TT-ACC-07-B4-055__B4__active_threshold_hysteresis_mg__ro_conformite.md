# TT-ACC-07-B4-055 — Bloc 4 — active_threshold_hysteresis_mg

## Objectif
Vérifier que le comportement observé du champ `active_threshold_hysteresis_mg` est strictement conforme au mapping.
