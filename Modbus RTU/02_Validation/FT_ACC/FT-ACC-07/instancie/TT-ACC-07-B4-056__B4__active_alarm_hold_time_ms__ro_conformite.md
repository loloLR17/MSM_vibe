# TT-ACC-07-B4-056 — Bloc 4 — active_alarm_hold_time_ms

## Objectif
Vérifier que le comportement observé du champ `active_alarm_hold_time_ms` est strictement conforme au mapping.
