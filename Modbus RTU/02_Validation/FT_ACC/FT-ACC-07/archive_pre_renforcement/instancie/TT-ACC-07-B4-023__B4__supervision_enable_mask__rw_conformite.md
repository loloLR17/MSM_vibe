# TT-ACC-07-B4-023 — Bloc 4 — supervision_enable_mask

## Objectif
Vérifier que le comportement observé du champ `supervision_enable_mask` est strictement conforme au mapping.
