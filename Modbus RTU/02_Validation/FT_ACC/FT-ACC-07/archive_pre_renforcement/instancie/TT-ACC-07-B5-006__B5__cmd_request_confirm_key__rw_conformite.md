# TT-ACC-07-B5-006 — Bloc 5 — cmd_request_confirm_key

## Objectif
Vérifier que le comportement observé du champ `cmd_request_confirm_key` est strictement conforme au mapping.
