# TT-ACC-07-B0-004 — Bloc 0 — firmware_version_minor

## Objectif
Vérifier que le comportement observé du champ `firmware_version_minor` est strictement conforme au mapping.
