# TT-ACC-07-B4-040 — Bloc 4 — active_sampling_frequency_hz

## Objectif
Vérifier que le comportement observé du champ `active_sampling_frequency_hz` est strictement conforme au mapping.
