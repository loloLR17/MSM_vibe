# TT-ACC-07-B4-001 — Bloc 4 — config_structure_version

## Objectif
Vérifier que le comportement observé du champ `config_structure_version` est strictement conforme au mapping.
