# TT-ACC-07-B4-050 — Bloc 4 — active_supervision_enable_mask

## Objectif
Vérifier que le comportement observé du champ `active_supervision_enable_mask` est strictement conforme au mapping.
