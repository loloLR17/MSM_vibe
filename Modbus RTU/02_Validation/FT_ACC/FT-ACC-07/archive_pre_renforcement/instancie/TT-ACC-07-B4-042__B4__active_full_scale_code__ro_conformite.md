# TT-ACC-07-B4-042 — Bloc 4 — active_full_scale_code

## Objectif
Vérifier que le comportement observé du champ `active_full_scale_code` est strictement conforme au mapping.
