# TT-ACC-07-B4-064 — Bloc 4 — active_load_state_code

## Objectif
Vérifier que le comportement observé du champ `active_load_state_code` est strictement conforme au mapping.
