# TT-ACC-07-B5-009 — Bloc 5 — cmd_active_transaction_id

## Objectif
Vérifier que le comportement observé du champ `cmd_active_transaction_id` est strictement conforme au mapping.
