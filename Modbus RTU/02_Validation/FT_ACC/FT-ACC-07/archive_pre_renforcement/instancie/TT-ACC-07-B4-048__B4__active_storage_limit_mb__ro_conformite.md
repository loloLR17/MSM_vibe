# TT-ACC-07-B4-048 — Bloc 4 — active_storage_limit_mb

## Objectif
Vérifier que le comportement observé du champ `active_storage_limit_mb` est strictement conforme au mapping.
