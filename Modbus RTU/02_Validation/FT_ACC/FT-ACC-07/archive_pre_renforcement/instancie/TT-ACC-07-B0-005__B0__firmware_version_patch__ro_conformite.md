# TT-ACC-07-B0-005 — Bloc 0 — firmware_version_patch

## Objectif
Vérifier que le comportement observé du champ `firmware_version_patch` est strictement conforme au mapping.
