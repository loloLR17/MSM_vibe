# TT-ACC-07-B4-045 — Bloc 4 — active_indicator_period_ms

## Objectif
Vérifier que le comportement observé du champ `active_indicator_period_ms` est strictement conforme au mapping.
