# TT-ACC-07-B4-052 — Bloc 4 — active_rms_alarm_threshold_mg

## Objectif
Vérifier que le comportement observé du champ `active_rms_alarm_threshold_mg` est strictement conforme au mapping.
