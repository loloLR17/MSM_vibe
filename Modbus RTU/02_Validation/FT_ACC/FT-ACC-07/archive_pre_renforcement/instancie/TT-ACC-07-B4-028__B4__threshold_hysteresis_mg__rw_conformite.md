# TT-ACC-07-B4-028 — Bloc 4 — threshold_hysteresis_mg

## Objectif
Vérifier que le comportement observé du champ `threshold_hysteresis_mg` est strictement conforme au mapping.
