# TT-ACC-06-GEN-006 — Écriture partiellement hors plage (début)

## 1. Objectif
Valider le traitement d’une requête Modbus invalide pour le scénario `Écriture partiellement hors plage (début)`.
