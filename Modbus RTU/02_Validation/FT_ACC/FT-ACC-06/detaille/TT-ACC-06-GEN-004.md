# TT-ACC-06-GEN-004 — Lecture partiellement hors plage (début)

## 1. Objectif
Valider le traitement d’une requête Modbus invalide pour le scénario `Lecture partiellement hors plage (début)`.
