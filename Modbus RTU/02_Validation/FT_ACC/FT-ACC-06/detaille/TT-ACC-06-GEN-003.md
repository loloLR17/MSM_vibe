# TT-ACC-06-GEN-003 — Lecture partiellement hors plage (fin)

## 1. Objectif
Valider le traitement d’une requête Modbus invalide pour le scénario `Lecture partiellement hors plage (fin)`.
