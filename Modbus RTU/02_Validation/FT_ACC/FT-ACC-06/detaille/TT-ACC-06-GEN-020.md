# TT-ACC-06-GEN-020 — Vérification mémoire après write invalide

## 1. Objectif
Valider le traitement d’une requête Modbus invalide pour le scénario `Vérification mémoire après write invalide`.
