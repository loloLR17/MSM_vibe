# TT-ACC-06-B3-005 — Bloc 3 — lecture_debordement_fin_bloc
...
Lecture à partir de 3047 sur 2 registres, débordant hors du bloc 3
...
2. Exécuter la requête lecture invalide à l’adresse `3047` sur `2` registre(s).
