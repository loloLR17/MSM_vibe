# TT-ACC-06-B4-005 — Bloc 4 — lecture_debordement_fin_bloc
...
Lecture à partir de 4175 sur 2 registres, débordant hors du bloc 4
...
2. Exécuter la requête lecture invalide à l’adresse `4175` sur `2` registre(s).
