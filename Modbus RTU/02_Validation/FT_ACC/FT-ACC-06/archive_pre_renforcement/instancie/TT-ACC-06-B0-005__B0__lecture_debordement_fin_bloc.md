# TT-ACC-06-B0-005 — Bloc 0 — lecture_debordement_fin_bloc
...
Lecture à partir de 20 sur 2 registres, débordant hors du bloc 0
...
2. Exécuter la requête lecture invalide à l’adresse `20` sur `2` registre(s).
