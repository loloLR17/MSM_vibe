# TT-ACC-06-B0-008 — Bloc 0 — ecriture_multi_bloc
...
Écriture franchissant la frontière bloc 0 -> bloc 1
...
2. Exécuter la requête ecriture invalide à l’adresse `20` sur `981` registre(s).
