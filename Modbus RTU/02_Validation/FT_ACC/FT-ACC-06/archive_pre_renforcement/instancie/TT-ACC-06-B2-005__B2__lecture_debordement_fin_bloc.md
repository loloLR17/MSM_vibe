# TT-ACC-06-B2-005 — Bloc 2 — lecture_debordement_fin_bloc
...
Lecture à partir de 2015 sur 2 registres, débordant hors du bloc 2
...
2. Exécuter la requête lecture invalide à l’adresse `2015` sur `2` registre(s).
