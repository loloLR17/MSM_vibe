# TT-ACC-06-B3-007 — Bloc 3 — lecture_multi_bloc
...
Lecture franchissant la frontière bloc 3 -> bloc 4
...
2. Exécuter la requête lecture invalide à l’adresse `3047` sur `954` registre(s).
