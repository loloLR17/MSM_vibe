# TT-ACC-06-B4-007 — Bloc 4 — lecture_multi_bloc
...
Lecture franchissant la frontière bloc 4 -> bloc 5
...
2. Exécuter la requête lecture invalide à l’adresse `4175` sur `826` registre(s).
