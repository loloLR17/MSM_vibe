# TT-ACC-06-B7-005 — Bloc 7 — lecture_debordement_fin_bloc
...
Lecture à partir de 7015 sur 2 registres, débordant hors du bloc 7
...
2. Exécuter la requête lecture invalide à l’adresse `7015` sur `2` registre(s).
