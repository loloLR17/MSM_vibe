# TT-ACC-06-B3-006 — Bloc 3 — ecriture_debordement_fin_bloc
...
Écriture à partir de 3047 sur 2 registres, débordant hors du bloc 3
...
2. Exécuter la requête ecriture invalide à l’adresse `3047` sur `2` registre(s).
