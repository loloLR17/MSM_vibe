# TT-ACC-06-B4-011 — Bloc 4 — frontiere_config_error_code_vers_prepared_config_crc
...
## Référence mapping
- Champ amont : config_error_code (4007..4007, accès RO)
- Champ aval : prepared_config_crc (4008..4009, accès RW)
