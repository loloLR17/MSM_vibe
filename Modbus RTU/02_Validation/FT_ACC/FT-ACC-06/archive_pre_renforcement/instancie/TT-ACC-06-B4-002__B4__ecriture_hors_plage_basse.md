# TT-ACC-06-B4-002 — Bloc 4 — ecriture_hors_plage_basse
...
- Adresse requête : 3999
- Longueur requête : 1

## Justification du scénario
Adresse 3999 avant début du bloc 4 (4000..4175)
...
2. Exécuter la requête ecriture invalide à l’adresse `3999` sur `1` registre(s).
