# TT-ACC-06-B2-008 — Bloc 2 — ecriture_multi_bloc
...
- Longueur requête : 986

## Justification du scénario
Écriture franchissant la frontière bloc 2 -> bloc 3
...
2. Exécuter la requête ecriture invalide à l’adresse `2015` sur `986` registre(s).
