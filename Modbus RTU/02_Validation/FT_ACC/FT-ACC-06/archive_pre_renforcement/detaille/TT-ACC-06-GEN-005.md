# TT-ACC-06-GEN-005 — Écriture partiellement hors plage (fin)

## 1. Objectif
Valider le traitement d’une requête Modbus invalide pour le scénario `Écriture partiellement hors plage (fin)`.
