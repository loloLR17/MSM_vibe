# TT-ACC-06-B0-002 — Bloc 0 — ecriture_hors_plage_basse
...
Adresse -1 avant début du bloc 0 (0..20)
...
2. Exécuter la requête ecriture invalide à l’adresse `-1` sur `1` registre(s).
