# TT-ACC-06-B6-005 — Bloc 6 — lecture_debordement_fin_bloc
...
Lecture à partir de 6063 sur 2 registres, débordant hors du bloc 6
...
2. Exécuter la requête lecture invalide à l’adresse `6063` sur `2` registre(s).
