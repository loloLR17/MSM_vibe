# TT-ACC-06-B4-008 — Bloc 4 — ecriture_multi_bloc
...
- Longueur requête : 826

## Justification du scénario
Écriture franchissant la frontière bloc 4 -> bloc 5
...
2. Exécuter la requête ecriture invalide à l’adresse `4175` sur `826` registre(s).
