# TT-ACC-06-B0-006 — Bloc 0 — ecriture_debordement_fin_bloc
...
Écriture à partir de 20 sur 2 registres, débordant hors du bloc 0
...
2. Exécuter la requête ecriture invalide à l’adresse `20` sur `2` registre(s).
