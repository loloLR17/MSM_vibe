# TT-ACC-06-B3-004 — Bloc 3 — ecriture_hors_plage_haute
...
- Adresse requête : 3048
- Longueur requête : 1

## Justification du scénario
Adresse 3048 après fin du bloc 3 (3000..3047)
...
2. Exécuter la requête ecriture invalide à l’adresse `3048` sur `1` registre(s).
