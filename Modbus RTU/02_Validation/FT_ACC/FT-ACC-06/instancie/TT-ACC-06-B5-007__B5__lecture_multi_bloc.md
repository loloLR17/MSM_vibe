# TT-ACC-06-B5-007 — Bloc 5 — lecture_multi_bloc
...
Lecture franchissant la frontière bloc 5 -> bloc 6
...
2. Exécuter la requête lecture invalide à l’adresse `5019` sur `982` registre(s).
