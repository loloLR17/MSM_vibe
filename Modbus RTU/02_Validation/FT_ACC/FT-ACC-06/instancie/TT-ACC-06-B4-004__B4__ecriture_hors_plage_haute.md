# TT-ACC-06-B4-004 — Bloc 4 — ecriture_hors_plage_haute
...
- Adresse requête : 4176
- Longueur requête : 1

## Justification du scénario
Adresse 4176 après fin du bloc 4 (4000..4175)
...
2. Exécuter la requête ecriture invalide à l’adresse `4176` sur `1` registre(s).
