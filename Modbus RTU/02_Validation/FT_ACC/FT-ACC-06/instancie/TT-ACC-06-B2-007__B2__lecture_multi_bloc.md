# TT-ACC-06-B2-007 — Bloc 2 — lecture_multi_bloc
...
Lecture franchissant la frontière bloc 2 -> bloc 3
...
2. Exécuter la requête lecture invalide à l’adresse `2015` sur `986` registre(s).
