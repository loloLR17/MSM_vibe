# TT-ACC-06-B4-022 — Bloc 4 — frontiere_sea_state_code_vers_reserved_4D
...
## Référence mapping
- Champ amont : sea_state_code (4095..4095, accès RW)
- Champ aval : reserved_4D (4096..4099, accès RO)
