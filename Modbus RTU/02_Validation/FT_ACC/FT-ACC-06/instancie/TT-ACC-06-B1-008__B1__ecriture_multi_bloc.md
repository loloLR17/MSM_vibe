# TT-ACC-06-B1-008 — Bloc 1 — ecriture_multi_bloc
...
Écriture franchissant la frontière bloc 1 -> bloc 2
...
2. Exécuter la requête ecriture invalide à l’adresse `1019` sur `982` registre(s).
