# TT-ACC-06-B6-007 — Bloc 6 — lecture_multi_bloc
...
Lecture franchissant la frontière bloc 6 -> bloc 7
...
2. Exécuter la requête lecture invalide à l’adresse `6063` sur `938` registre(s).
