# TT-ACC-06-B1-005 — Bloc 1 — lecture_debordement_fin_bloc
...
Lecture à partir de 1019 sur 2 registres, débordant hors du bloc 1
...
2. Exécuter la requête lecture invalide à l’adresse `1019` sur `2` registre(s).
