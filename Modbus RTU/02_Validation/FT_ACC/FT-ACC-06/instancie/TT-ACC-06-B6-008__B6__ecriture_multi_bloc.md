# TT-ACC-06-B6-008 — Bloc 6 — ecriture_multi_bloc
...
- Longueur requête : 938

## Justification du scénario
Écriture franchissant la frontière bloc 6 -> bloc 7
...
2. Exécuter la requête ecriture invalide à l’adresse `6063` sur `938` registre(s).
