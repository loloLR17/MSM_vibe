# TT-ACC-05-B5-007 — Bloc 5 — cmd_request_control

## Objectif
Vérifier qu’une écriture sur `cmd_request_control` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 5
- Adresse début cible : 5007
- Adresse fin cible : 5007
...
2. Écrire exactement `1` registre(s) sur `5007..5007`.
3. Relire l’image complète du bloc `5`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `5007..5007` diffèrent.
