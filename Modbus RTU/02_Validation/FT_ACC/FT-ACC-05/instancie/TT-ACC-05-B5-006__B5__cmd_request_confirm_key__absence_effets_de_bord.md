# TT-ACC-05-B5-006 — Bloc 5 — cmd_request_confirm_key

## Objectif
Vérifier qu’une écriture sur `cmd_request_confirm_key` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 5
- Adresse début cible : 5006
- Adresse fin cible : 5006
- Type déclaré : uint16
...
2. Écrire exactement `1` registre(s) sur `5006..5006`.
3. Relire l’image complète du bloc `5`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `5006..5006` diffèrent.
