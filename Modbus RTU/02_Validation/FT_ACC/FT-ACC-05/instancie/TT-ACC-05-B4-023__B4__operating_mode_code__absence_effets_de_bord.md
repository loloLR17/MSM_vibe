# TT-ACC-05-B4-023 — Bloc 4 — operating_mode_code

## Objectif
Vérifier qu’une écriture sur `operating_mode_code` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 4
- Adresse début cible : 4092
- Adresse fin cible : 4092
- Type déclaré : uint16
...
2. Écrire exactement `1` registre(s) sur `4092..4092`.
3. Relire l’image complète du bloc `4`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `4092..4092` diffèrent.
