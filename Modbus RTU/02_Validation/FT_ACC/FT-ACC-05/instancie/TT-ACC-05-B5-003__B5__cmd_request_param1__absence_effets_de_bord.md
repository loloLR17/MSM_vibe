# TT-ACC-05-B5-003 — Bloc 5 — cmd_request_param1

## Objectif
Vérifier qu’une écriture sur `cmd_request_param1` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 5
- Adresse début cible : 5002
- Adresse fin cible : 5002
- Type déclaré : uint16
...
2. Écrire exactement `1` registre(s) sur `5002..5002`.
3. Relire l’image complète du bloc `5`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `5002..5002` diffèrent.
