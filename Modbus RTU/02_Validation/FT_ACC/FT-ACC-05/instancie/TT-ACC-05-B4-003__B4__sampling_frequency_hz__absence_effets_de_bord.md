# TT-ACC-05-B4-003 — Bloc 4 — sampling_frequency_hz

## Objectif
Vérifier qu’une écriture sur `sampling_frequency_hz` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 4
- Adresse début cible : 4016
- Adresse fin cible : 4016
- Type déclaré : uint16
...
2. Écrire exactement `1` registre(s) sur `4016..4016`.
3. Relire l’image complète du bloc `4`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `4016..4016` diffèrent.
