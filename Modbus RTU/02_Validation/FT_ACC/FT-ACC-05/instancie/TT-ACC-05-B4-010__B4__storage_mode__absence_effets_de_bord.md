# TT-ACC-05-B4-010 — Bloc 4 — storage_mode

## Objectif
Vérifier qu’une écriture sur `storage_mode` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 4
- Adresse début cible : 4025
- Adresse fin cible : 4025
- Type déclaré : uint16
...
2. Écrire exactement `1` registre(s) sur `4025..4025`.
3. Relire l’image complète du bloc `4`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `4025..4025` diffèrent.
