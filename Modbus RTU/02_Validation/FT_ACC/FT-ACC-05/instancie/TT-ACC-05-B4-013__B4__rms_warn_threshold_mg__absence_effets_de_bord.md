# TT-ACC-05-B4-013 — Bloc 4 — rms_warn_threshold_mg

## Objectif
Vérifier qu’une écriture sur `rms_warn_threshold_mg` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 4
- Adresse début cible : 4041
- Adresse fin cible : 4041
- Type déclaré : uint16
...
2. Écrire exactement `1` registre(s) sur `4041..4041`.
3. Relire l’image complète du bloc `4`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `4041..4041` diffèrent.
