# TT-ACC-05-B4-008 — Bloc 4 — indicator_period_ms

## Objectif
Vérifier qu’une écriture sur `indicator_period_ms` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 4
- Adresse début cible : 4022
- Adresse fin cible : 4022
- Type déclaré : uint16
...
2. Écrire exactement `1` registre(s) sur `4022..4022`.
3. Relire l’image complète du bloc `4`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `4022..4022` diffèrent.
