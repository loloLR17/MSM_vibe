# TT-ACC-05-B4-006 — Bloc 4 — acquisition_mode

## Objectif
Vérifier qu’une écriture sur `acquisition_mode` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 4
- Adresse début cible : 4020
- Adresse fin cible : 4020
- Type déclaré : uint16
...
2. Écrire exactement `1` registre(s) sur `4020..4020`.
3. Relire l’image complète du bloc `4`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `4020..4020` diffèrent.
