# TT-ACC-05-B4-021 — Bloc 4 — campaign_label

## Objectif
Vérifier qu’une écriture sur `campaign_label` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 4
- Adresse début cible : 4060
- Adresse fin cible : 4075
...
2. Écrire exactement `16` registre(s) sur `4060..4075`.
3. Relire l’image complète du bloc `4`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `4060..4075` diffèrent.
