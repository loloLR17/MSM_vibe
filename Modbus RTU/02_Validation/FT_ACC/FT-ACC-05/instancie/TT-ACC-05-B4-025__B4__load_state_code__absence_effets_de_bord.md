# TT-ACC-05-B4-025 — Bloc 4 — load_state_code

## Objectif
Vérifier qu’une écriture sur `load_state_code` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 4
- Adresse début cible : 4094
- Adresse fin cible : 4094
- Type déclaré : uint16
...
2. Écrire exactement `1` registre(s) sur `4094..4094`.
3. Relire l’image complète du bloc `4`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `4094..4094` diffèrent.
