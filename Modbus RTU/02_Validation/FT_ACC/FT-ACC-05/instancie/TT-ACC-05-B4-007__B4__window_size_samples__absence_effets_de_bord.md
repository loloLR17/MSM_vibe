# TT-ACC-05-B4-007 — Bloc 4 — window_size_samples

## Objectif
Vérifier qu’une écriture sur `window_size_samples` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 4
- Adresse début cible : 4021
- Adresse fin cible : 4021
- Type déclaré : uint16
...
2. Écrire exactement `1` registre(s) sur `4021..4021`.
3. Relire l’image complète du bloc `4`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `4021..4021` diffèrent.
