# TT-ACC-05-B4-017 — Bloc 4 — threshold_hysteresis_mg

## Objectif
Vérifier qu’une écriture sur `threshold_hysteresis_mg` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 4
- Adresse début cible : 4045
- Adresse fin cible : 4045
- Type déclaré : uint16
...
2. Écrire exactement `1` registre(s) sur `4045..4045`.
3. Relire l’image complète du bloc `4`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `4045..4045` diffèrent.
