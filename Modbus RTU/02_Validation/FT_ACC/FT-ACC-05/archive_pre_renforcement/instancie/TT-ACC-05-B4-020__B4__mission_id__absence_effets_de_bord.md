# TT-ACC-05-B4-020 — Bloc 4 — mission_id

## Objectif
Vérifier qu’une écriture sur `mission_id` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 4
- Adresse début cible : 4058
- Adresse fin cible : 4059
- Type déclaré : uint32
...
2. Écrire exactement `2` registre(s) sur `4058..4059`.
3. Relire l’image complète du bloc `4`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `4058..4059` diffèrent.
