# TT-ACC-05-B5-004 — Bloc 5 — cmd_request_param2

## Objectif
Vérifier qu’une écriture sur `cmd_request_param2` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 5
- Adresse début cible : 5003
- Adresse fin cible : 5003
- Type déclaré : uint16
...
2. Écrire exactement `1` registre(s) sur `5003..5003`.
3. Relire l’image complète du bloc `5`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `5003..5003` diffèrent.
