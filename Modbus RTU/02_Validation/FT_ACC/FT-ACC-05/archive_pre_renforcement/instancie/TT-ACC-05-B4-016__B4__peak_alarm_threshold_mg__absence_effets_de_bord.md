# TT-ACC-05-B4-016 — Bloc 4 — peak_alarm_threshold_mg

## Objectif
Vérifier qu’une écriture sur `peak_alarm_threshold_mg` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 4
- Adresse début cible : 4044
- Adresse fin cible : 4044
- Type déclaré : uint16
...
2. Écrire exactement `1` registre(s) sur `4044..4044`.
3. Relire l’image complète du bloc `4`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `4044..4044` diffèrent.
