# TT-ACC-05-B4-005 — Bloc 4 — full_scale_code

## Objectif
Vérifier qu’une écriture sur `full_scale_code` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 4
- Adresse début cible : 4019
- Adresse fin cible : 4019
- Type déclaré : uint16
...
2. Écrire exactement `1` registre(s) sur `4019..4019`.
3. Relire l’image complète du bloc `4`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `4019..4019` diffèrent.
