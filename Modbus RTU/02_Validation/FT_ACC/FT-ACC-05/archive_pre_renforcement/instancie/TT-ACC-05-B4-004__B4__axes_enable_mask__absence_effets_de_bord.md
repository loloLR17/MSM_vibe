# TT-ACC-05-B4-004 — Bloc 4 — axes_enable_mask

## Objectif
Vérifier qu’une écriture sur `axes_enable_mask` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 4
- Adresse début cible : 4018
- Adresse fin cible : 4018
- Type déclaré : uint16
...
2. Écrire exactement `1` registre(s) sur `4018..4018`.
3. Relire l’image complète du bloc `4`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `4018..4018` diffèrent.
