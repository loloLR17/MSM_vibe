# TT-ACC-05-B4-012 — Bloc 4 — supervision_enable_mask

## Objectif
Vérifier qu’une écriture sur `supervision_enable_mask` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 4
- Adresse début cible : 4040
- Adresse fin cible : 4040
- Type déclaré : uint16
...
2. Écrire exactement `1` registre(s) sur `4040..4040`.
3. Relire l’image complète du bloc `4`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `4040..4040` diffèrent.
