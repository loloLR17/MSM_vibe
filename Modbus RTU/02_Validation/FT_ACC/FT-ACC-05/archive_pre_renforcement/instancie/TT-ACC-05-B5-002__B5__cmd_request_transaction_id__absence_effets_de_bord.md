# TT-ACC-05-B5-002 — Bloc 5 — cmd_request_transaction_id

## Objectif
Vérifier qu’une écriture sur `cmd_request_transaction_id` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 5
- Adresse début cible : 5001
- Adresse fin cible : 5001
- Type déclaré : uint16
...
2. Écrire exactement `1` registre(s) sur `5001..5001`.
3. Relire l’image complète du bloc `5`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `5001..5001` diffèrent.
