# TT-ACC-05-B4-009 — Bloc 4 — campaign_duration_s

## Objectif
Vérifier qu’une écriture sur `campaign_duration_s` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 4
- Adresse début cible : 4023
- Adresse fin cible : 4024
- Type déclaré : uint32
...
2. Écrire exactement `2` registre(s) sur `4023..4024`.
3. Relire l’image complète du bloc `4`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `4023..4024` diffèrent.
