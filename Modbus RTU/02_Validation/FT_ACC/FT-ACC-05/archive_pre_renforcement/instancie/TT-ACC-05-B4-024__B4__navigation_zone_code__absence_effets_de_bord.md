# TT-ACC-05-B4-024 — Bloc 4 — navigation_zone_code

## Objectif
Vérifier qu’une écriture sur `navigation_zone_code` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 4
- Adresse début cible : 4093
- Adresse fin cible : 4093
- Type déclaré : uint16
...
2. Écrire exactement `1` registre(s) sur `4093..4093`.
3. Relire l’image complète du bloc `4`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `4093..4093` diffèrent.
