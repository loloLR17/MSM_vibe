# TT-ACC-05-B4-002 — Bloc 4 — prepared_config_crc

## Objectif
Vérifier qu’une écriture sur `prepared_config_crc` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 4
- Adresse début cible : 4008
- Adresse fin cible : 4009
- Type déclaré : uint32
...
2. Écrire exactement `2` registre(s) sur `4008..4009`.
3. Relire l’image complète du bloc `4`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `4008..4009` diffèrent.
