# TT-ACC-05-B4-018 — Bloc 4 — alarm_hold_time_ms

## Objectif
Vérifier qu’une écriture sur `alarm_hold_time_ms` n’entraîne aucune modification hors de la plage ciblée.

## Référence mapping
- Bloc : 4
- Adresse début cible : 4046
- Adresse fin cible : 4046
- Type déclaré : uint16
...
2. Écrire exactement `1` registre(s) sur `4046..4046`.
3. Relire l’image complète du bloc `4`.
4. Calculer le diff adressé.
5. Vérifier que seules les adresses `4046..4046` diffèrent.
